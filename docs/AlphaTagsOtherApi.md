...
|------------- | ------------- | -------------|
| [**deleteAlphaTag**](AlphaTagsOtherApi.md#deleteAlphaTag) | **DELETE** /v3/alpha-tags/{alpha_tag_id} | Delete Alpha Tag |
| [**getAlphaTag**](AlphaTagsOtherApi.md#getAlphaTag) | **GET** /v3/alpha-tags/{alpha_tag_id} | Get Alpha Tag |
| [**listAlphaTags**](AlphaTagsOtherApi.md#listAlphaTags) | **GET** /v3/alpha-tags | List Alpha Tags |
| [**requestAlphaTag**](AlphaTagsOtherApi.md#requestAlphaTag) | **POST** /v3/alpha-tags | Request Alpha Tag |
...
import org.openapitools.client.api.AlphaTagsOtherApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    AlphaTagsOtherApi apiInstance = new AlphaTagsOtherApi(defaultClient);
    String alphaTagId = "alphaTagId_example"; // String | 
    String contentType = "application/json"; // String | 
    try {
      apiInstance.deleteAlphaTag(alphaTagId, contentType);
    } catch (ApiException e) {
      System.err.println("Exception when calling AlphaTagsOtherApi#deleteAlphaTag");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AlphaTagsOtherApi#getAlphaTag");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AlphaTagsOtherApi#listAlphaTags");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling AlphaTagsOtherApi#requestAlphaTag");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
