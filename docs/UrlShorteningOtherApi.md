...
|------------- | ------------- | -------------|
| [**shortUrlGetStatistics**](UrlShorteningOtherApi.md#shortUrlGetStatistics) | **GET** /v3/short-url/statistics/{source}/{source_id} | Get Statistics |
| [**shortUrlGetTracking**](UrlShorteningOtherApi.md#shortUrlGetTracking) | **GET** /v3/short-url/tracking/{long_url_id} | Get Tracking |
...
import org.openapitools.client.api.UrlShorteningOtherApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    UrlShorteningOtherApi apiInstance = new UrlShorteningOtherApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling UrlShorteningOtherApi#shortUrlGetStatistics");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling UrlShorteningOtherApi#shortUrlGetTracking");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
