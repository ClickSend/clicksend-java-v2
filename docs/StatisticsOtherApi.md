...
|------------- | ------------- | -------------|
| [**viewSmsStatistics**](StatisticsOtherApi.md#viewSmsStatistics) | **GET** /v3/statistics/sms | View SMS Statistics |
| [**viewVoiceStatistics**](StatisticsOtherApi.md#viewVoiceStatistics) | **GET** /v3/statistics/voice | View Voice Statistics |
...
import org.openapitools.client.api.StatisticsOtherApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    StatisticsOtherApi apiInstance = new StatisticsOtherApi(defaultClient);
    String contentType = "application/json"; // String | 
    try {
      ViewSmsStatistics result = apiInstance.viewSmsStatistics(contentType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling StatisticsOtherApi#viewSmsStatistics");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling StatisticsOtherApi#viewVoiceStatistics");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
