...
import org.openapitools.client.api.ContactListApi;
...
<a id="listsImportByListIdPost"></a>
# **listsImportByListIdPost**
> String listsImportByListIdPost(listId, _file)
...
public class Example {
  public static void main(String[] args) {
    ...
    ContactListImport _file = new ContactListImport(); // ContactListImport | ContactListImport model
    try {
...
<a id="listsRemoveDuplicatesByListIdPut"></a>
