...
|**messageSearchType** | **BigDecimal** | Message Search Type: 0&#x3D;Any message, 1&#x3D;starts with, 2&#x3D;contains, 3&#x3D;does not contain. |  |
...
|**enabled** | **BigDecimal** | Enabled: Disabled&#x3D;0 or Enabled&#x3D;1. |  |
