...
|------------- | ------------- | -------------|
| [**forgotPassword**](VerificationOtherApi.md#forgotPassword) | **PUT** /v3/forgot-password | Forgot Password |
| [**forgotUsername**](VerificationOtherApi.md#forgotUsername) | **PUT** /v3/forgot-username | Forgot Username |
...
import org.openapitools.client.api.VerificationOtherApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    VerificationOtherApi apiInstance = new VerificationOtherApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling VerificationOtherApi#forgotPassword");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling VerificationOtherApi#forgotUsername");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
