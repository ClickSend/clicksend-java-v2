...
|------------- | ------------- | -------------|
| [**createDeliveryIssue**](MessageDeliveryOtherApi.md#createDeliveryIssue) | **POST** /v3/delivery-issues | Create Delivery Issues |
| [**getAllDeliveryIssues**](MessageDeliveryOtherApi.md#getAllDeliveryIssues) | **GET** /v3/delivery-issues | Get All Delivery Issues |
...
import org.openapitools.client.api.MessageDeliveryOtherApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    MessageDeliveryOtherApi apiInstance = new MessageDeliveryOtherApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling MessageDeliveryOtherApi#createDeliveryIssue");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling MessageDeliveryOtherApi#getAllDeliveryIssues");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
