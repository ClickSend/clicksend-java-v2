...
|------------- | ------------- | -------------|
| [**viewReferralAccounts**](ReferralsOtherApi.md#viewReferralAccounts) | **GET** /v3/referral/accounts/ | View Referral Accounts |
...
import ClickSend.Api.ReferralsOtherApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ReferralsOtherApi apiInstance = new ReferralsOtherApi(defaultClient);
    String contentType = "application/json"; // String | 
    try {
      ViewReferralAccounts result = apiInstance.viewReferralAccounts(contentType);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling ReferralsOtherApi#viewReferralAccounts");
