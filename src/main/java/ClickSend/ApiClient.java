...
import ClickSend.auth.Authentication;
import ClickSend.auth.HttpBasicAuth;
import ClickSend.auth.HttpBearerAuth;
import ClickSend.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    protected String basePath = "https://rest.clicksend.com";
    ...
    protected void init() {
        ...
        setUserAgent("ClickSend-SDK/6.0.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://rest.clicksend.com)
     ...
     * @return a {@link ClickSend.ApiClient} object
     */
    ...
    */
     ...
     * @throws ClickSend.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws ClickSend.ApiException If fail to serialize the given object
     */
     ...
     * @throws ClickSend.ApiException If fail to read file content from response and write to disk
     ...
     * @throws ClickSend.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws ClickSend.ApiException If the response has an unsuccessful status code or
     ...
     * @throws ClickSend.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws ClickSend.ApiException If fails to update the parameters
     */
     ...
     * @throws ClickSend.ApiException If fail to serialize the request body object into a string
     */
