...
public class VerifyAllowedEmailAddress {
  ...
  public VerifyAllowedEmailAddress() {
  }

  public VerifyAllowedEmailAddress httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public VerifyAllowedEmailAddress responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public VerifyAllowedEmailAddress responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public VerifyAllowedEmailAddress data(@javax.annotation.Nullable EmailAddress data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable EmailAddress data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    VerifyAllowedEmailAddress verifyAllowedEmailAddress = (VerifyAllowedEmailAddress) o;
    return Objects.equals(this.httpCode, verifyAllowedEmailAddress.httpCode) &&
        Objects.equals(this.responseCode, verifyAllowedEmailAddress.responseCode) &&
        Objects.equals(this.responseMsg, verifyAllowedEmailAddress.responseMsg) &&
        Objects.equals(this.data, verifyAllowedEmailAddress.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class VerifyAllowedEmailAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to VerifyAllowedEmailAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VerifyAllowedEmailAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in VerifyAllowedEmailAddress is not found in the empty JSON string", VerifyAllowedEmailAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VerifyAllowedEmailAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `VerifyAllowedEmailAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        EmailAddress.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VerifyAllowedEmailAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VerifyAllowedEmailAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VerifyAllowedEmailAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VerifyAllowedEmailAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<VerifyAllowedEmailAddress>() {
           @Override
           public void write(JsonWriter out, VerifyAllowedEmailAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public VerifyAllowedEmailAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of VerifyAllowedEmailAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of VerifyAllowedEmailAddress
   * @throws IOException if the JSON string is invalid with respect to VerifyAllowedEmailAddress
   */
  public static VerifyAllowedEmailAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VerifyAllowedEmailAddress.class);
  }

  /**
   * Convert an instance of VerifyAllowedEmailAddress to an JSON string
   *
   * @return JSON string
   */
