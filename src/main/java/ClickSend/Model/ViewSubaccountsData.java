...
public class ViewSubaccountsData {
  ...
  public ViewSubaccountsData() {
  }

  public ViewSubaccountsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewSubaccountsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewSubaccountsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewSubaccountsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewSubaccountsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewSubaccountsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewSubaccountsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewSubaccountsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewSubaccountsData data(@javax.annotation.Nullable List<Subaccount> data) {
    this.data = data;
    return this;
  }

  public ViewSubaccountsData addDataItem(Subaccount dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    ViewSubaccountsData viewSubaccountsData = (ViewSubaccountsData) o;
    return Objects.equals(this.total, viewSubaccountsData.total) &&
        Objects.equals(this.perPage, viewSubaccountsData.perPage) &&
        Objects.equals(this.currentPage, viewSubaccountsData.currentPage) &&
        Objects.equals(this.lastPage, viewSubaccountsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewSubaccountsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewSubaccountsData.prevPageUrl) &&
        Objects.equals(this.from, viewSubaccountsData.from) &&
        Objects.equals(this.to, viewSubaccountsData.to) &&
        Objects.equals(this.data, viewSubaccountsData.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSubaccountsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSubaccountsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSubaccountsData is not found in the empty JSON string", ViewSubaccountsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSubaccountsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSubaccountsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSubaccountsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSubaccountsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSubaccountsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSubaccountsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSubaccountsData>() {
           @Override
           public void write(JsonWriter out, ViewSubaccountsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSubaccountsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSubaccountsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSubaccountsData
   * @throws IOException if the JSON string is invalid with respect to ViewSubaccountsData
   */
  public static ViewSubaccountsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSubaccountsData.class);
  }

  /**
   * Convert an instance of ViewSubaccountsData to an JSON string
   *
   * @return JSON string
   */
