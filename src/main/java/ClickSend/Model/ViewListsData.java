...
public class ViewListsData {
  ...
  public ViewListsData() {
  }

  public ViewListsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewListsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewListsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewListsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewListsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewListsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewListsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewListsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewListsData firstPageUrl(@javax.annotation.Nullable String firstPageUrl) {
  ...
  public ViewListsData lastPageUrl(@javax.annotation.Nullable String lastPageUrl) {
  ...
  public ViewListsData path(@javax.annotation.Nullable String path) {
    this.path = path;
    return this;
  }
  ...
  public ViewListsData links(@javax.annotation.Nullable List<ViewListsDataLinksInner> links) {
    this.links = links;
    return this;
  }

  public ViewListsData addLinksItem(ViewListsDataLinksInner linksItem) {
    if (this.links == null) {
  ...
  public ViewListsData data(@javax.annotation.Nullable List<ContactList> data) {
    this.data = data;
    return this;
  }

  public ViewListsData addDataItem(ContactList dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<ContactList> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewListsData viewListsData = (ViewListsData) o;
    return Objects.equals(this.total, viewListsData.total) &&
        Objects.equals(this.perPage, viewListsData.perPage) &&
        Objects.equals(this.currentPage, viewListsData.currentPage) &&
        Objects.equals(this.lastPage, viewListsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewListsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewListsData.prevPageUrl) &&
        Objects.equals(this.from, viewListsData.from) &&
        Objects.equals(this.to, viewListsData.to) &&
        Objects.equals(this.firstPageUrl, viewListsData.firstPageUrl) &&
        Objects.equals(this.lastPageUrl, viewListsData.lastPageUrl) &&
        Objects.equals(this.path, viewListsData.path) &&
        Objects.equals(this.links, viewListsData.links) &&
        Objects.equals(this.data, viewListsData.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewListsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewListsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewListsData is not found in the empty JSON string", ViewListsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewListsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewListsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewListsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewListsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewListsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewListsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewListsData>() {
           @Override
           public void write(JsonWriter out, ViewListsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewListsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewListsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewListsData
   * @throws IOException if the JSON string is invalid with respect to ViewListsData
   */
  public static ViewListsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewListsData.class);
  }

  /**
   * Convert an instance of ViewListsData to an JSON string
   *
   * @return JSON string
   */
