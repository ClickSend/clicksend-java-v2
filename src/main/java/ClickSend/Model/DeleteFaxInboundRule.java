...
public class DeleteFaxInboundRule {
  ...
  public DeleteFaxInboundRule() {
  }

  public DeleteFaxInboundRule httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteFaxInboundRule responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteFaxInboundRule responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteFaxInboundRule data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteFaxInboundRule addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteFaxInboundRule deleteFaxInboundRule = (DeleteFaxInboundRule) o;
    return Objects.equals(this.httpCode, deleteFaxInboundRule.httpCode) &&
        Objects.equals(this.responseCode, deleteFaxInboundRule.responseCode) &&
        Objects.equals(this.responseMsg, deleteFaxInboundRule.responseMsg) &&
        Objects.equals(this.data, deleteFaxInboundRule.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteFaxInboundRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFaxInboundRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFaxInboundRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteFaxInboundRule is not found in the empty JSON string", DeleteFaxInboundRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFaxInboundRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteFaxInboundRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFaxInboundRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFaxInboundRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFaxInboundRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFaxInboundRule.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFaxInboundRule>() {
           @Override
           public void write(JsonWriter out, DeleteFaxInboundRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFaxInboundRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFaxInboundRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFaxInboundRule
   * @throws IOException if the JSON string is invalid with respect to DeleteFaxInboundRule
   */
  public static DeleteFaxInboundRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFaxInboundRule.class);
  }

  /**
   * Convert an instance of DeleteFaxInboundRule to an JSON string
   *
   * @return JSON string
   */
