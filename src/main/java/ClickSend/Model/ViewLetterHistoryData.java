...
public class ViewLetterHistoryData {
  ...
  public ViewLetterHistoryData() {
  }

  public ViewLetterHistoryData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewLetterHistoryData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewLetterHistoryData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewLetterHistoryData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewLetterHistoryData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewLetterHistoryData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewLetterHistoryData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewLetterHistoryData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewLetterHistoryData data(@javax.annotation.Nullable List<Recipient> data) {
    this.data = data;
    return this;
  }

  public ViewLetterHistoryData addDataItem(Recipient dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<Recipient> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewLetterHistoryData viewLetterHistoryData = (ViewLetterHistoryData) o;
    return Objects.equals(this.total, viewLetterHistoryData.total) &&
        Objects.equals(this.perPage, viewLetterHistoryData.perPage) &&
        Objects.equals(this.currentPage, viewLetterHistoryData.currentPage) &&
        Objects.equals(this.lastPage, viewLetterHistoryData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewLetterHistoryData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewLetterHistoryData.prevPageUrl) &&
        Objects.equals(this.from, viewLetterHistoryData.from) &&
        Objects.equals(this.to, viewLetterHistoryData.to) &&
        Objects.equals(this.data, viewLetterHistoryData.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewLetterHistoryData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewLetterHistoryData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewLetterHistoryData is not found in the empty JSON string", ViewLetterHistoryData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewLetterHistoryData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewLetterHistoryData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Recipient.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewLetterHistoryData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewLetterHistoryData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewLetterHistoryData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewLetterHistoryData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewLetterHistoryData>() {
           @Override
           public void write(JsonWriter out, ViewLetterHistoryData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewLetterHistoryData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewLetterHistoryData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewLetterHistoryData
   * @throws IOException if the JSON string is invalid with respect to ViewLetterHistoryData
   */
  public static ViewLetterHistoryData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewLetterHistoryData.class);
  }

  /**
   * Convert an instance of ViewLetterHistoryData to an JSON string
   *
   * @return JSON string
   */
