...
import ClickSend.Model.Country;
...
public class ViewCountries {
  ...
  public ViewCountries httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewCountries responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewCountries responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewCountries data(@javax.annotation.Nullable List<Country> data) {
    this.data = data;
    return this;
  }

  public ViewCountries addDataItem(Country dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<Country> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewCountries viewCountries = (ViewCountries) o;
    return Objects.equals(this.httpCode, viewCountries.httpCode) &&
        Objects.equals(this.responseCode, viewCountries.responseCode) &&
        Objects.equals(this.responseMsg, viewCountries.responseMsg) &&
        Objects.equals(this.data, viewCountries.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewCountries
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewCountries.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewCountries is not found in the empty JSON string", ViewCountries.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewCountries.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewCountries` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewCountries.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewCountries' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewCountries> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewCountries.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewCountries>() {
           @Override
           public void write(JsonWriter out, ViewCountries value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewCountries read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewCountries given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewCountries
   * @throws IOException if the JSON string is invalid with respect to ViewCountries
   */
  public static ViewCountries fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewCountries.class);
  }

  /**
   * Convert an instance of ViewCountries to an JSON string
   *
   * @return JSON string
   */
