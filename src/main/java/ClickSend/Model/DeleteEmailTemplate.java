...
public class DeleteEmailTemplate {
  ...
  public DeleteEmailTemplate httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteEmailTemplate responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteEmailTemplate responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteEmailTemplate data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteEmailTemplate addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, deleteEmailTemplate.httpCode) &&
        Objects.equals(this.responseCode, deleteEmailTemplate.responseCode) &&
        Objects.equals(this.responseMsg, deleteEmailTemplate.responseMsg) &&
        Objects.equals(this.data, deleteEmailTemplate.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteEmailTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteEmailTemplate is not found in the empty JSON string", DeleteEmailTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteEmailTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteEmailTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
