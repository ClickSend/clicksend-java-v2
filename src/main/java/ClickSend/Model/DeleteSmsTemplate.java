...
public class DeleteSmsTemplate {
  ...
  public DeleteSmsTemplate httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteSmsTemplate responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteSmsTemplate responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteSmsTemplate data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteSmsTemplate addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSmsTemplate deleteSmsTemplate = (DeleteSmsTemplate) o;
    return Objects.equals(this.httpCode, deleteSmsTemplate.httpCode) &&
        Objects.equals(this.responseCode, deleteSmsTemplate.responseCode) &&
        Objects.equals(this.responseMsg, deleteSmsTemplate.responseMsg) &&
        Objects.equals(this.data, deleteSmsTemplate.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSmsTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSmsTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSmsTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteSmsTemplate is not found in the empty JSON string", DeleteSmsTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSmsTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteSmsTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSmsTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSmsTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSmsTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSmsTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSmsTemplate>() {
           @Override
           public void write(JsonWriter out, DeleteSmsTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSmsTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSmsTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSmsTemplate
   * @throws IOException if the JSON string is invalid with respect to DeleteSmsTemplate
   */
  public static DeleteSmsTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSmsTemplate.class);
  }

  /**
   * Convert an instance of DeleteSmsTemplate to an JSON string
   *
   * @return JSON string
   */
