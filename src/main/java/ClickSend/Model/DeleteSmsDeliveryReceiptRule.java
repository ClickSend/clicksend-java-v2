...
public class DeleteSmsDeliveryReceiptRule {
  ...
  public DeleteSmsDeliveryReceiptRule() {
  }

  public DeleteSmsDeliveryReceiptRule httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteSmsDeliveryReceiptRule responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteSmsDeliveryReceiptRule responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteSmsDeliveryReceiptRule data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteSmsDeliveryReceiptRule addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSmsDeliveryReceiptRule deleteSmsDeliveryReceiptRule = (DeleteSmsDeliveryReceiptRule) o;
    return Objects.equals(this.httpCode, deleteSmsDeliveryReceiptRule.httpCode) &&
        Objects.equals(this.responseCode, deleteSmsDeliveryReceiptRule.responseCode) &&
        Objects.equals(this.responseMsg, deleteSmsDeliveryReceiptRule.responseMsg) &&
        Objects.equals(this.data, deleteSmsDeliveryReceiptRule.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSmsDeliveryReceiptRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSmsDeliveryReceiptRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSmsDeliveryReceiptRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteSmsDeliveryReceiptRule is not found in the empty JSON string", DeleteSmsDeliveryReceiptRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSmsDeliveryReceiptRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteSmsDeliveryReceiptRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSmsDeliveryReceiptRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSmsDeliveryReceiptRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSmsDeliveryReceiptRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSmsDeliveryReceiptRule.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSmsDeliveryReceiptRule>() {
           @Override
           public void write(JsonWriter out, DeleteSmsDeliveryReceiptRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSmsDeliveryReceiptRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSmsDeliveryReceiptRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSmsDeliveryReceiptRule
   * @throws IOException if the JSON string is invalid with respect to DeleteSmsDeliveryReceiptRule
   */
  public static DeleteSmsDeliveryReceiptRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSmsDeliveryReceiptRule.class);
  }

  /**
   * Convert an instance of DeleteSmsDeliveryReceiptRule to an JSON string
   *
   * @return JSON string
   */
