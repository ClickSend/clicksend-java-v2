...
public class ViewSpecificFaxReceipt {
  ...
  public ViewSpecificFaxReceipt() {
  }

  public ViewSpecificFaxReceipt httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewSpecificFaxReceipt responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewSpecificFaxReceipt responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewSpecificFaxReceipt data(@javax.annotation.Nullable Fax data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable Fax data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSpecificFaxReceipt viewSpecificFaxReceipt = (ViewSpecificFaxReceipt) o;
    return Objects.equals(this.httpCode, viewSpecificFaxReceipt.httpCode) &&
        Objects.equals(this.responseCode, viewSpecificFaxReceipt.responseCode) &&
        Objects.equals(this.responseMsg, viewSpecificFaxReceipt.responseMsg) &&
        Objects.equals(this.data, viewSpecificFaxReceipt.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSpecificFaxReceipt {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSpecificFaxReceipt
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSpecificFaxReceipt.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSpecificFaxReceipt is not found in the empty JSON string", ViewSpecificFaxReceipt.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSpecificFaxReceipt.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSpecificFaxReceipt` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Fax.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSpecificFaxReceipt.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSpecificFaxReceipt' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSpecificFaxReceipt> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSpecificFaxReceipt.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSpecificFaxReceipt>() {
           @Override
           public void write(JsonWriter out, ViewSpecificFaxReceipt value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSpecificFaxReceipt read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSpecificFaxReceipt given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSpecificFaxReceipt
   * @throws IOException if the JSON string is invalid with respect to ViewSpecificFaxReceipt
   */
  public static ViewSpecificFaxReceipt fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSpecificFaxReceipt.class);
  }

  /**
   * Convert an instance of ViewSpecificFaxReceipt to an JSON string
   *
   * @return JSON string
   */
