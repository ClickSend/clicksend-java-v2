...
public class CancelScheduledLetter {
  ...
  public CancelScheduledLetter() {
  }

  public CancelScheduledLetter httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CancelScheduledLetter responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CancelScheduledLetter responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CancelScheduledLetter data(@javax.annotation.Nullable Boolean data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelScheduledLetter cancelScheduledLetter = (CancelScheduledLetter) o;
    return Objects.equals(this.httpCode, cancelScheduledLetter.httpCode) &&
        Objects.equals(this.responseCode, cancelScheduledLetter.responseCode) &&
        Objects.equals(this.responseMsg, cancelScheduledLetter.responseMsg) &&
        Objects.equals(this.data, cancelScheduledLetter.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelScheduledLetter {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelScheduledLetter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelScheduledLetter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelScheduledLetter is not found in the empty JSON string", CancelScheduledLetter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelScheduledLetter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelScheduledLetter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelScheduledLetter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelScheduledLetter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelScheduledLetter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelScheduledLetter.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelScheduledLetter>() {
           @Override
           public void write(JsonWriter out, CancelScheduledLetter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelScheduledLetter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelScheduledLetter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelScheduledLetter
   * @throws IOException if the JSON string is invalid with respect to CancelScheduledLetter
   */
  public static CancelScheduledLetter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelScheduledLetter.class);
  }

  /**
   * Convert an instance of CancelScheduledLetter to an JSON string
   *
   * @return JSON string
   */
