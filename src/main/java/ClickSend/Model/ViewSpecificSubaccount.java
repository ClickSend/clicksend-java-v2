...
public class ViewSpecificSubaccount {
  ...
  public ViewSpecificSubaccount() {
  }

  public ViewSpecificSubaccount httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewSpecificSubaccount responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewSpecificSubaccount responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewSpecificSubaccount data(@javax.annotation.Nullable Subaccount data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public Subaccount getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable Subaccount data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSpecificSubaccount viewSpecificSubaccount = (ViewSpecificSubaccount) o;
    return Objects.equals(this.httpCode, viewSpecificSubaccount.httpCode) &&
        Objects.equals(this.responseCode, viewSpecificSubaccount.responseCode) &&
        Objects.equals(this.responseMsg, viewSpecificSubaccount.responseMsg) &&
        Objects.equals(this.data, viewSpecificSubaccount.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSpecificSubaccount {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSpecificSubaccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSpecificSubaccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSpecificSubaccount is not found in the empty JSON string", ViewSpecificSubaccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSpecificSubaccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSpecificSubaccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        Subaccount.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSpecificSubaccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSpecificSubaccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSpecificSubaccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSpecificSubaccount.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSpecificSubaccount>() {
           @Override
           public void write(JsonWriter out, ViewSpecificSubaccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSpecificSubaccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSpecificSubaccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSpecificSubaccount
   * @throws IOException if the JSON string is invalid with respect to ViewSpecificSubaccount
   */
  public static ViewSpecificSubaccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSpecificSubaccount.class);
  }

  /**
   * Convert an instance of ViewSpecificSubaccount to an JSON string
   *
   * @return JSON string
   */
