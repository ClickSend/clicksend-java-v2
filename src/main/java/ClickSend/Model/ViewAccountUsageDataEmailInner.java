...
public class ViewAccountUsageDataEmailInner {
  ...
  public ViewAccountUsageDataEmailInner subaccountId(@javax.annotation.Nullable Integer subaccountId) {
  ...
  public ViewAccountUsageDataEmailInner username(@javax.annotation.Nullable String username) {
  ...
  public ViewAccountUsageDataEmailInner totalCount(@javax.annotation.Nullable Integer totalCount) {
  ...
  public boolean equals(Object o) {
    ...
    ViewAccountUsageDataEmailInner viewAccountUsageDataEmailInner = (ViewAccountUsageDataEmailInner) o;
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAccountUsageDataEmailInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAccountUsageDataEmailInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAccountUsageDataEmailInner is not found in the empty JSON string", ViewAccountUsageDataEmailInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAccountUsageDataEmailInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAccountUsageDataEmailInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAccountUsageDataEmailInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAccountUsageDataEmailInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAccountUsageDataEmailInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAccountUsageDataEmailInner.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAccountUsageDataEmailInner>() {
           @Override
           public void write(JsonWriter out, ViewAccountUsageDataEmailInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAccountUsageDataEmailInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAccountUsageDataEmailInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAccountUsageDataEmailInner
   * @throws IOException if the JSON string is invalid with respect to ViewAccountUsageDataEmailInner
   */
  public static ViewAccountUsageDataEmailInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAccountUsageDataEmailInner.class);
  }

  /**
   * Convert an instance of ViewAccountUsageDataEmailInner to an JSON string
   *
   * @return JSON string
   */
