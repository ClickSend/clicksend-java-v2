...
public class ViewFaxHistoryData {
  ...
  @javax.annotation.Nullable
  private List<Fax> data = new ArrayList<>();

  public ViewFaxHistoryData() {
  }

  public ViewFaxHistoryData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewFaxHistoryData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewFaxHistoryData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewFaxHistoryData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewFaxHistoryData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewFaxHistoryData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewFaxHistoryData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewFaxHistoryData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewFaxHistoryData data(@javax.annotation.Nullable List<Fax> data) {
    this.data = data;
    return this;
  }

  public ViewFaxHistoryData addDataItem(Fax dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<Fax> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewFaxHistoryData viewFaxHistoryData = (ViewFaxHistoryData) o;
    return Objects.equals(this.total, viewFaxHistoryData.total) &&
        Objects.equals(this.perPage, viewFaxHistoryData.perPage) &&
        Objects.equals(this.currentPage, viewFaxHistoryData.currentPage) &&
        Objects.equals(this.lastPage, viewFaxHistoryData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewFaxHistoryData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewFaxHistoryData.prevPageUrl) &&
        Objects.equals(this.from, viewFaxHistoryData.from) &&
        Objects.equals(this.to, viewFaxHistoryData.to) &&
        Objects.equals(this.data, viewFaxHistoryData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewFaxHistoryData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewFaxHistoryData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewFaxHistoryData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewFaxHistoryData is not found in the empty JSON string", ViewFaxHistoryData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewFaxHistoryData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewFaxHistoryData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            Fax.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewFaxHistoryData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewFaxHistoryData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewFaxHistoryData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewFaxHistoryData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewFaxHistoryData>() {
           @Override
           public void write(JsonWriter out, ViewFaxHistoryData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewFaxHistoryData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewFaxHistoryData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewFaxHistoryData
   * @throws IOException if the JSON string is invalid with respect to ViewFaxHistoryData
   */
  public static ViewFaxHistoryData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewFaxHistoryData.class);
  }

  /**
   * Convert an instance of ViewFaxHistoryData to an JSON string
   *
   * @return JSON string
   */
