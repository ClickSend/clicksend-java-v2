...
public class VoiceMessageSchedule extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(VoiceMessageSchedule.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!VoiceMessageSchedule.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'VoiceMessageSchedule' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<VoiceMessageSchedule>() {
                @Override
                public void write(JsonWriter out, VoiceMessageSchedule value) throws IOException {
                ...
                @Override
                public VoiceMessageSchedule read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        VoiceMessageSchedule ret = new VoiceMessageSchedule();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for VoiceMessageSchedule: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public VoiceMessageSchedule() {
        super("oneOf", Boolean.FALSE);
    }

    public VoiceMessageSchedule(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return VoiceMessageSchedule.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to VoiceMessageSchedule
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for VoiceMessageSchedule with oneOf schemas: Integer, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of VoiceMessageSchedule given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of VoiceMessageSchedule
     * @throws IOException if the JSON string is invalid with respect to VoiceMessageSchedule
     */
    public static VoiceMessageSchedule fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, VoiceMessageSchedule.class);
    }

    /**
     * Convert an instance of VoiceMessageSchedule to an JSON string
     *
     * @return JSON string
     */
