...
public class CalculateSmsPriceRequestMessagesInner {
  ...
  public static final String SERIALIZED_NAME_SHOW_SUMMARY = "show_summary";
  @SerializedName(SERIALIZED_NAME_SHOW_SUMMARY)
  @javax.annotation.Nullable
  private Boolean showSummary;

  public CalculateSmsPriceRequestMessagesInner() {
  }

  public CalculateSmsPriceRequestMessagesInner body(@javax.annotation.Nonnull String body) {
    this.body = body;
    return this;
  }
  ...
  public CalculateSmsPriceRequestMessagesInner to(@javax.annotation.Nullable String to) {
    this.to = to;
    return this;
  }
  ...
  public CalculateSmsPriceRequestMessagesInner from(@javax.annotation.Nullable String from) {
    this.from = from;
    return this;
  }
  ...
  public CalculateSmsPriceRequestMessagesInner source(@javax.annotation.Nullable String source) {
    this.source = source;
    return this;
  }
  ...
  public CalculateSmsPriceRequestMessagesInner schedule(@javax.annotation.Nullable Integer schedule) {
  ...
  public CalculateSmsPriceRequestMessagesInner customString(@javax.annotation.Nullable String customString) {
  ...
  public CalculateSmsPriceRequestMessagesInner listId(@javax.annotation.Nullable String listId) {
    this.listId = listId;
    return this;
  }
  ...
  public CalculateSmsPriceRequestMessagesInner contactId(@javax.annotation.Nullable String contactId) {
  ...
  public CalculateSmsPriceRequestMessagesInner country(@javax.annotation.Nullable String country) {
  ...
  public CalculateSmsPriceRequestMessagesInner showSummary(@javax.annotation.Nullable Boolean showSummary) {
  ...
  public void setShowSummary(@javax.annotation.Nullable Boolean showSummary) {
    this.showSummary = showSummary;
  }
  ...
  public boolean equals(Object o) {
    ...
    CalculateSmsPriceRequestMessagesInner calculateSmsPriceRequestMessagesInner = (CalculateSmsPriceRequestMessagesInner) o;
    return Objects.equals(this.body, calculateSmsPriceRequestMessagesInner.body) &&
        Objects.equals(this.to, calculateSmsPriceRequestMessagesInner.to) &&
        Objects.equals(this.from, calculateSmsPriceRequestMessagesInner.from) &&
        Objects.equals(this.source, calculateSmsPriceRequestMessagesInner.source) &&
        Objects.equals(this.schedule, calculateSmsPriceRequestMessagesInner.schedule) &&
        Objects.equals(this.customString, calculateSmsPriceRequestMessagesInner.customString) &&
        Objects.equals(this.listId, calculateSmsPriceRequestMessagesInner.listId) &&
        Objects.equals(this.contactId, calculateSmsPriceRequestMessagesInner.contactId) &&
        Objects.equals(this.country, calculateSmsPriceRequestMessagesInner.country) &&
        Objects.equals(this.showSummary, calculateSmsPriceRequestMessagesInner.showSummary);
  }

  @Override
  public int hashCode() {
    return Objects.hash(body, to, from, source, schedule, customString, listId, contactId, country, showSummary);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CalculateSmsPriceRequestMessagesInner {\n");
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("body", "to", "from", "source", "schedule", "custom_string", "list_id", "contact_id", "country", "show_summary"));
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateSmsPriceRequestMessagesInner
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateSmsPriceRequestMessagesInner.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CalculateSmsPriceRequestMessagesInner is not found in the empty JSON string", CalculateSmsPriceRequestMessagesInner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateSmsPriceRequestMessagesInner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CalculateSmsPriceRequestMessagesInner` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CalculateSmsPriceRequestMessagesInner.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CalculateSmsPriceRequestMessagesInner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CalculateSmsPriceRequestMessagesInner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CalculateSmsPriceRequestMessagesInner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CalculateSmsPriceRequestMessagesInner.class));

       return (TypeAdapter<T>) new TypeAdapter<CalculateSmsPriceRequestMessagesInner>() {
           @Override
           public void write(JsonWriter out, CalculateSmsPriceRequestMessagesInner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CalculateSmsPriceRequestMessagesInner read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CalculateSmsPriceRequestMessagesInner given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CalculateSmsPriceRequestMessagesInner
   * @throws IOException if the JSON string is invalid with respect to CalculateSmsPriceRequestMessagesInner
   */
  public static CalculateSmsPriceRequestMessagesInner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CalculateSmsPriceRequestMessagesInner.class);
  }

  /**
   * Convert an instance of CalculateSmsPriceRequestMessagesInner to an JSON string
   *
   * @return JSON string
   */
