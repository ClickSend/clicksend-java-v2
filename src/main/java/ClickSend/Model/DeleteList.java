...
public class DeleteList {
  ...
  public DeleteList httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteList responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteList responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteList data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteList addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteList deleteList = (DeleteList) o;
    return Objects.equals(this.httpCode, deleteList.httpCode) &&
        Objects.equals(this.responseCode, deleteList.responseCode) &&
        Objects.equals(this.responseMsg, deleteList.responseMsg) &&
        Objects.equals(this.data, deleteList.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteList is not found in the empty JSON string", DeleteList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteList.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteList>() {
           @Override
           public void write(JsonWriter out, DeleteList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteList
   * @throws IOException if the JSON string is invalid with respect to DeleteList
   */
  public static DeleteList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteList.class);
  }

  /**
   * Convert an instance of DeleteList to an JSON string
   *
   * @return JSON string
   */
