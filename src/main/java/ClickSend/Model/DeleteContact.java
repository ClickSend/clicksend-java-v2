...
public class DeleteContact {
  ...
  public DeleteContact httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteContact responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteContact responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteContact data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteContact addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, deleteContact.httpCode) &&
        Objects.equals(this.responseCode, deleteContact.responseCode) &&
        Objects.equals(this.responseMsg, deleteContact.responseMsg) &&
        Objects.equals(this.data, deleteContact.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteContact is not found in the empty JSON string", DeleteContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteContact.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteContact>() {
           @Override
           public void write(JsonWriter out, DeleteContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteContact
   * @throws IOException if the JSON string is invalid with respect to DeleteContact
   */
  public static DeleteContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteContact.class);
  }

  /**
   * Convert an instance of DeleteContact to an JSON string
   *
   * @return JSON string
   */
