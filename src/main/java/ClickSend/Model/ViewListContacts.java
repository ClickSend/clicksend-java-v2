...
public class ViewListContacts {
  ...
  @javax.annotation.Nullable
  private ViewListContactsData data;

  public ViewListContacts() {
  }

  public ViewListContacts httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewListContacts responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewListContacts responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewListContacts data(@javax.annotation.Nullable ViewListContactsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewListContactsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewListContactsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewListContacts viewListContacts = (ViewListContacts) o;
    return Objects.equals(this.httpCode, viewListContacts.httpCode) &&
        Objects.equals(this.responseCode, viewListContacts.responseCode) &&
        Objects.equals(this.responseMsg, viewListContacts.responseMsg) &&
        Objects.equals(this.data, viewListContacts.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewListContacts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewListContacts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewListContacts is not found in the empty JSON string", ViewListContacts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewListContacts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewListContacts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewListContactsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewListContacts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewListContacts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewListContacts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewListContacts.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewListContacts>() {
           @Override
           public void write(JsonWriter out, ViewListContacts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewListContacts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewListContacts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewListContacts
   * @throws IOException if the JSON string is invalid with respect to ViewListContacts
   */
  public static ViewListContacts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewListContacts.class);
  }

  /**
   * Convert an instance of ViewListContacts to an JSON string
   *
   * @return JSON string
   */
