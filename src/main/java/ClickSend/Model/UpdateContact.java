...
public class UpdateContact {
  ...
  public UpdateContact httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdateContact responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateContact responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateContact data(@javax.annotation.Nullable Contact data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, updateContact.httpCode) &&
        Objects.equals(this.responseCode, updateContact.responseCode) &&
        Objects.equals(this.responseMsg, updateContact.responseMsg) &&
        Objects.equals(this.data, updateContact.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateContact is not found in the empty JSON string", UpdateContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateContact.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateContact>() {
           @Override
           public void write(JsonWriter out, UpdateContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateContact
   * @throws IOException if the JSON string is invalid with respect to UpdateContact
   */
  public static UpdateContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateContact.class);
  }

  /**
   * Convert an instance of UpdateContact to an JSON string
   *
   * @return JSON string
   */
