...
public class DeleteSubaccount {
  ...
  public DeleteSubaccount httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteSubaccount responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteSubaccount responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteSubaccount data(@javax.annotation.Nullable Boolean data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteSubaccount deleteSubaccount = (DeleteSubaccount) o;
    return Objects.equals(this.httpCode, deleteSubaccount.httpCode) &&
        Objects.equals(this.responseCode, deleteSubaccount.responseCode) &&
        Objects.equals(this.responseMsg, deleteSubaccount.responseMsg) &&
        Objects.equals(this.data, deleteSubaccount.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSubaccount {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSubaccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSubaccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteSubaccount is not found in the empty JSON string", DeleteSubaccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSubaccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteSubaccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSubaccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSubaccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSubaccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSubaccount.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSubaccount>() {
           @Override
           public void write(JsonWriter out, DeleteSubaccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSubaccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSubaccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSubaccount
   * @throws IOException if the JSON string is invalid with respect to DeleteSubaccount
   */
  public static DeleteSubaccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSubaccount.class);
  }

  /**
   * Convert an instance of DeleteSubaccount to an JSON string
   *
   * @return JSON string
   */
