...
public class ViewSpecificList {
  ...
  public ViewSpecificList() {
  }

  public ViewSpecificList httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewSpecificList responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewSpecificList responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewSpecificList data(@javax.annotation.Nullable ContactList data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable ContactList data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSpecificList viewSpecificList = (ViewSpecificList) o;
    return Objects.equals(this.httpCode, viewSpecificList.httpCode) &&
        Objects.equals(this.responseCode, viewSpecificList.responseCode) &&
        Objects.equals(this.responseMsg, viewSpecificList.responseMsg) &&
        Objects.equals(this.data, viewSpecificList.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSpecificList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSpecificList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSpecificList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSpecificList is not found in the empty JSON string", ViewSpecificList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSpecificList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSpecificList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ContactList.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSpecificList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSpecificList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSpecificList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSpecificList.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSpecificList>() {
           @Override
           public void write(JsonWriter out, ViewSpecificList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSpecificList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSpecificList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSpecificList
   * @throws IOException if the JSON string is invalid with respect to ViewSpecificList
   */
  public static ViewSpecificList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSpecificList.class);
  }

  /**
   * Convert an instance of ViewSpecificList to an JSON string
   *
   * @return JSON string
   */
