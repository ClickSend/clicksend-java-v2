...
public class DeleteStrippedStringRule {
  ...
  public DeleteStrippedStringRule() {
  }

  public DeleteStrippedStringRule httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteStrippedStringRule responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteStrippedStringRule responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteStrippedStringRule data(@javax.annotation.Nullable Boolean data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteStrippedStringRule deleteStrippedStringRule = (DeleteStrippedStringRule) o;
    return Objects.equals(this.httpCode, deleteStrippedStringRule.httpCode) &&
        Objects.equals(this.responseCode, deleteStrippedStringRule.responseCode) &&
        Objects.equals(this.responseMsg, deleteStrippedStringRule.responseMsg) &&
        Objects.equals(this.data, deleteStrippedStringRule.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteStrippedStringRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteStrippedStringRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteStrippedStringRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteStrippedStringRule is not found in the empty JSON string", DeleteStrippedStringRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteStrippedStringRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteStrippedStringRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteStrippedStringRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteStrippedStringRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteStrippedStringRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteStrippedStringRule.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteStrippedStringRule>() {
           @Override
           public void write(JsonWriter out, DeleteStrippedStringRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteStrippedStringRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteStrippedStringRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteStrippedStringRule
   * @throws IOException if the JSON string is invalid with respect to DeleteStrippedStringRule
   */
  public static DeleteStrippedStringRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteStrippedStringRule.class);
  }

  /**
   * Convert an instance of DeleteStrippedStringRule to an JSON string
   *
   * @return JSON string
   */
