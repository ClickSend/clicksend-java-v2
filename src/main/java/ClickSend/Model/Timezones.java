...
public class Timezones {
  ...
  public Timezones httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public Timezones responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public Timezones responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public Timezones data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public Timezones addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    Timezones timezones = (Timezones) o;
    return Objects.equals(this.httpCode, timezones.httpCode) &&
        Objects.equals(this.responseCode, timezones.responseCode) &&
        Objects.equals(this.responseMsg, timezones.responseMsg) &&
        Objects.equals(this.data, timezones.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Timezones
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Timezones.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Timezones is not found in the empty JSON string", Timezones.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Timezones.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Timezones` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Timezones.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Timezones' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Timezones> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Timezones.class));

       return (TypeAdapter<T>) new TypeAdapter<Timezones>() {
           @Override
           public void write(JsonWriter out, Timezones value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public Timezones read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of Timezones given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of Timezones
   * @throws IOException if the JSON string is invalid with respect to Timezones
   */
  public static Timezones fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Timezones.class);
  }

  /**
   * Convert an instance of Timezones to an JSON string
   *
   * @return JSON string
   */
