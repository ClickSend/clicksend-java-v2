...
public class ViewAccountDetails {
  ...
  public ViewAccountDetails httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewAccountDetails responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewAccountDetails responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewAccountDetails data(@javax.annotation.Nullable Account data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable Account data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewAccountDetails viewAccountDetails = (ViewAccountDetails) o;
    return Objects.equals(this.httpCode, viewAccountDetails.httpCode) &&
        Objects.equals(this.responseCode, viewAccountDetails.responseCode) &&
        Objects.equals(this.responseMsg, viewAccountDetails.responseMsg) &&
        Objects.equals(this.data, viewAccountDetails.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewAccountDetails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAccountDetails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAccountDetails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAccountDetails is not found in the empty JSON string", ViewAccountDetails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAccountDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAccountDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAccountDetails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAccountDetails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAccountDetails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAccountDetails.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAccountDetails>() {
           @Override
           public void write(JsonWriter out, ViewAccountDetails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAccountDetails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAccountDetails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAccountDetails
   * @throws IOException if the JSON string is invalid with respect to ViewAccountDetails
   */
  public static ViewAccountDetails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAccountDetails.class);
  }

  /**
   * Convert an instance of ViewAccountDetails to an JSON string
   *
   * @return JSON string
   */
