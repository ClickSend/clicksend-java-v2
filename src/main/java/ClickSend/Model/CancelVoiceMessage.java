...
public class CancelVoiceMessage {
  ...
  public CancelVoiceMessage httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CancelVoiceMessage responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CancelVoiceMessage responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CancelVoiceMessage data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public CancelVoiceMessage addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    CancelVoiceMessage cancelVoiceMessage = (CancelVoiceMessage) o;
    return Objects.equals(this.httpCode, cancelVoiceMessage.httpCode) &&
        Objects.equals(this.responseCode, cancelVoiceMessage.responseCode) &&
        Objects.equals(this.responseMsg, cancelVoiceMessage.responseMsg) &&
        Objects.equals(this.data, cancelVoiceMessage.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelVoiceMessage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelVoiceMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelVoiceMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelVoiceMessage is not found in the empty JSON string", CancelVoiceMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelVoiceMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelVoiceMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelVoiceMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelVoiceMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelVoiceMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelVoiceMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelVoiceMessage>() {
           @Override
           public void write(JsonWriter out, CancelVoiceMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelVoiceMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelVoiceMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelVoiceMessage
   * @throws IOException if the JSON string is invalid with respect to CancelVoiceMessage
   */
  public static CancelVoiceMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelVoiceMessage.class);
  }

  /**
   * Convert an instance of CancelVoiceMessage to an JSON string
   *
   * @return JSON string
   */
