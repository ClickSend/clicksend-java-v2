...
public class SendEmailVerificationToken {
  ...
  public SendEmailVerificationToken() {
  }

  public SendEmailVerificationToken httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendEmailVerificationToken responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendEmailVerificationToken responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendEmailVerificationToken data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendEmailVerificationToken sendEmailVerificationToken = (SendEmailVerificationToken) o;
    return Objects.equals(this.httpCode, sendEmailVerificationToken.httpCode) &&
        Objects.equals(this.responseCode, sendEmailVerificationToken.responseCode) &&
        Objects.equals(this.responseMsg, sendEmailVerificationToken.responseMsg) &&
        Objects.equals(this.data, sendEmailVerificationToken.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendEmailVerificationToken {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendEmailVerificationToken
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendEmailVerificationToken.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendEmailVerificationToken is not found in the empty JSON string", SendEmailVerificationToken.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendEmailVerificationToken.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendEmailVerificationToken` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendEmailVerificationToken.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendEmailVerificationToken' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendEmailVerificationToken> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendEmailVerificationToken.class));

       return (TypeAdapter<T>) new TypeAdapter<SendEmailVerificationToken>() {
           @Override
           public void write(JsonWriter out, SendEmailVerificationToken value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendEmailVerificationToken read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendEmailVerificationToken given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendEmailVerificationToken
   * @throws IOException if the JSON string is invalid with respect to SendEmailVerificationToken
   */
  public static SendEmailVerificationToken fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendEmailVerificationToken.class);
  }

  /**
   * Convert an instance of SendEmailVerificationToken to an JSON string
   *
   * @return JSON string
   */
