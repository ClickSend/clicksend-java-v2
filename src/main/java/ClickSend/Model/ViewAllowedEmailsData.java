...
public class ViewAllowedEmailsData {
  ...
  @javax.annotation.Nullable
  private List<ViewAllowedEmailsDataAllOfDataInner> data = new ArrayList<>();

  public ViewAllowedEmailsData() {
  }

  public ViewAllowedEmailsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewAllowedEmailsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewAllowedEmailsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewAllowedEmailsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewAllowedEmailsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewAllowedEmailsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewAllowedEmailsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewAllowedEmailsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewAllowedEmailsData data(@javax.annotation.Nullable List<ViewAllowedEmailsDataAllOfDataInner> data) {
    this.data = data;
    return this;
  }

  public ViewAllowedEmailsData addDataItem(ViewAllowedEmailsDataAllOfDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ViewAllowedEmailsDataAllOfDataInner> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ViewAllowedEmailsDataAllOfDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewAllowedEmailsData viewAllowedEmailsData = (ViewAllowedEmailsData) o;
    return Objects.equals(this.total, viewAllowedEmailsData.total) &&
        Objects.equals(this.perPage, viewAllowedEmailsData.perPage) &&
        Objects.equals(this.currentPage, viewAllowedEmailsData.currentPage) &&
        Objects.equals(this.lastPage, viewAllowedEmailsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewAllowedEmailsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewAllowedEmailsData.prevPageUrl) &&
        Objects.equals(this.from, viewAllowedEmailsData.from) &&
        Objects.equals(this.to, viewAllowedEmailsData.to) &&
        Objects.equals(this.data, viewAllowedEmailsData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewAllowedEmailsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAllowedEmailsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAllowedEmailsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAllowedEmailsData is not found in the empty JSON string", ViewAllowedEmailsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAllowedEmailsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAllowedEmailsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ViewAllowedEmailsDataAllOfDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAllowedEmailsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAllowedEmailsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAllowedEmailsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAllowedEmailsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAllowedEmailsData>() {
           @Override
           public void write(JsonWriter out, ViewAllowedEmailsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAllowedEmailsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAllowedEmailsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAllowedEmailsData
   * @throws IOException if the JSON string is invalid with respect to ViewAllowedEmailsData
   */
  public static ViewAllowedEmailsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAllowedEmailsData.class);
  }

  /**
   * Convert an instance of ViewAllowedEmailsData to an JSON string
   *
   * @return JSON string
   */
