...
public class CancelSms {
  ...
  public CancelSms httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CancelSms responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CancelSms responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CancelSms data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelSms cancelSms = (CancelSms) o;
    return Objects.equals(this.httpCode, cancelSms.httpCode) &&
        Objects.equals(this.responseCode, cancelSms.responseCode) &&
        Objects.equals(this.responseMsg, cancelSms.responseMsg) &&
        Objects.equals(this.data, cancelSms.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelSms
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelSms.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelSms is not found in the empty JSON string", CancelSms.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelSms.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelSms` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelSms.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelSms' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelSms> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelSms.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelSms>() {
           @Override
           public void write(JsonWriter out, CancelSms value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelSms read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelSms given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelSms
   * @throws IOException if the JSON string is invalid with respect to CancelSms
   */
  public static CancelSms fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelSms.class);
  }

  /**
   * Convert an instance of CancelSms to an JSON string
   *
   * @return JSON string
   */
