...
public class CreateSmsTemplate {
  ...
  public CreateSmsTemplate httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CreateSmsTemplate responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CreateSmsTemplate responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CreateSmsTemplate data(@javax.annotation.Nullable SmsTemplate data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SmsTemplate getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable SmsTemplate data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateSmsTemplate createSmsTemplate = (CreateSmsTemplate) o;
    return Objects.equals(this.httpCode, createSmsTemplate.httpCode) &&
        Objects.equals(this.responseCode, createSmsTemplate.responseCode) &&
        Objects.equals(this.responseMsg, createSmsTemplate.responseMsg) &&
        Objects.equals(this.data, createSmsTemplate.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSmsTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSmsTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSmsTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateSmsTemplate is not found in the empty JSON string", CreateSmsTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSmsTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateSmsTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        SmsTemplate.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSmsTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSmsTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSmsTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSmsTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSmsTemplate>() {
           @Override
           public void write(JsonWriter out, CreateSmsTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSmsTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSmsTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSmsTemplate
   * @throws IOException if the JSON string is invalid with respect to CreateSmsTemplate
   */
  public static CreateSmsTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSmsTemplate.class);
  }

  /**
   * Convert an instance of CreateSmsTemplate to an JSON string
   *
   * @return JSON string
   */
