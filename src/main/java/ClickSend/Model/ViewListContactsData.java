...
public class ViewListContactsData {
  ...
  public ViewListContactsData() {
  }

  public ViewListContactsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewListContactsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewListContactsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewListContactsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewListContactsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewListContactsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewListContactsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewListContactsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewListContactsData data(@javax.annotation.Nullable List<Contact> data) {
    this.data = data;
    return this;
  }

  public ViewListContactsData addDataItem(Contact dataItem) {
    if (this.data == null) {
  ...
  public void setData(@javax.annotation.Nullable List<Contact> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewListContactsData viewListContactsData = (ViewListContactsData) o;
    return Objects.equals(this.total, viewListContactsData.total) &&
        Objects.equals(this.perPage, viewListContactsData.perPage) &&
        Objects.equals(this.currentPage, viewListContactsData.currentPage) &&
        Objects.equals(this.lastPage, viewListContactsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewListContactsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewListContactsData.prevPageUrl) &&
        Objects.equals(this.from, viewListContactsData.from) &&
        Objects.equals(this.to, viewListContactsData.to) &&
        Objects.equals(this.data, viewListContactsData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewListContactsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewListContactsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewListContactsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewListContactsData is not found in the empty JSON string", ViewListContactsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewListContactsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewListContactsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewListContactsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewListContactsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewListContactsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewListContactsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewListContactsData>() {
           @Override
           public void write(JsonWriter out, ViewListContactsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewListContactsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewListContactsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewListContactsData
   * @throws IOException if the JSON string is invalid with respect to ViewListContactsData
   */
  public static ViewListContactsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewListContactsData.class);
  }

  /**
   * Convert an instance of ViewListContactsData to an JSON string
   *
   * @return JSON string
   */
