...
public class ViewVoiceLanguagesDataInnerGender extends AbstractOpenApiSchema {
    private static final Logger log = Logger.getLogger(ViewVoiceLanguagesDataInnerGender.class.getName());

    public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
        @SuppressWarnings("unchecked")
        @Override
        public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
            if (!ViewVoiceLanguagesDataInnerGender.class.isAssignableFrom(type.getRawType())) {
                return null; // this class only serializes 'ViewVoiceLanguagesDataInnerGender' and its subtypes
            }
            ...
            return (TypeAdapter<T>) new TypeAdapter<ViewVoiceLanguagesDataInnerGender>() {
                @Override
                public void write(JsonWriter out, ViewVoiceLanguagesDataInnerGender value) throws IOException {
                ...
                @Override
                public ViewVoiceLanguagesDataInnerGender read(JsonReader in) throws IOException {
                    ...
                    if (match == 1) {
                        ViewVoiceLanguagesDataInnerGender ret = new ViewVoiceLanguagesDataInnerGender();
                        ret.setActualInstance(actualAdapter.fromJsonTree(jsonElement));
                        return ret;
                    }

                    throw new IOException(String.format(java.util.Locale.ROOT, "Failed deserialization for ViewVoiceLanguagesDataInnerGender: %d classes match result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", match, errorMessages, jsonElement.toString()));
                }
            }.nullSafe();
        }
    }
    ...
    public ViewVoiceLanguagesDataInnerGender() {
        super("oneOf", Boolean.FALSE);
    }

    public ViewVoiceLanguagesDataInnerGender(Object o) {
        super("oneOf", Boolean.FALSE);
        setActualInstance(o);
    }
    ...
    public Map<String, Class<?>> getSchemas() {
        return ViewVoiceLanguagesDataInnerGender.schemas;
    }
     ...
     * @throws IOException if the JSON Element is invalid with respect to ViewVoiceLanguagesDataInnerGender
     */
    public static void validateJsonElement(JsonElement jsonElement) throws IOException {
        ...
        if (validCount != 1) {
            throw new IOException(String.format(java.util.Locale.ROOT, "The JSON string is invalid for ViewVoiceLanguagesDataInnerGender with oneOf schemas: List<String>, String. %d class(es) match the result, expected 1. Detailed failure message for oneOf schemas: %s. JSON: %s", validCount, errorMessages, jsonElement.toString()));
        }
    }

    /**
     * Create an instance of ViewVoiceLanguagesDataInnerGender given an JSON string
     *
     * @param jsonString JSON string
     * @return An instance of ViewVoiceLanguagesDataInnerGender
     * @throws IOException if the JSON string is invalid with respect to ViewVoiceLanguagesDataInnerGender
     */
    public static ViewVoiceLanguagesDataInnerGender fromJson(String jsonString) throws IOException {
        return JSON.getGson().fromJson(jsonString, ViewVoiceLanguagesDataInnerGender.class);
    }

    /**
     * Convert an instance of ViewVoiceLanguagesDataInnerGender to an JSON string
     *
     * @return JSON string
     */
