...
public class SendMmsCampaign {
  ...
  public SendMmsCampaign() {
  }

  public SendMmsCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendMmsCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendMmsCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendMmsCampaign data(@javax.annotation.Nullable MmsCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendMmsCampaign sendMmsCampaign = (SendMmsCampaign) o;
    return Objects.equals(this.httpCode, sendMmsCampaign.httpCode) &&
        Objects.equals(this.responseCode, sendMmsCampaign.responseCode) &&
        Objects.equals(this.responseMsg, sendMmsCampaign.responseMsg) &&
        Objects.equals(this.data, sendMmsCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendMmsCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMmsCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMmsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendMmsCampaign is not found in the empty JSON string", SendMmsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMmsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendMmsCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMmsCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMmsCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMmsCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMmsCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMmsCampaign>() {
           @Override
           public void write(JsonWriter out, SendMmsCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMmsCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMmsCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMmsCampaign
   * @throws IOException if the JSON string is invalid with respect to SendMmsCampaign
   */
  public static SendMmsCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMmsCampaign.class);
  }

  /**
   * Convert an instance of SendMmsCampaign to an JSON string
   *
   * @return JSON string
   */
