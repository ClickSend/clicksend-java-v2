...
import org.openapitools.client.model.ViewListsData;
...
public class ViewLists {
  ...
  @javax.annotation.Nullable
  private ViewListsData data;

  public ViewLists() {
  }

  public ViewLists httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewLists responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewLists responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewLists data(@javax.annotation.Nullable ViewListsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewListsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewListsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewLists viewLists = (ViewLists) o;
    return Objects.equals(this.httpCode, viewLists.httpCode) &&
        Objects.equals(this.responseCode, viewLists.responseCode) &&
        Objects.equals(this.responseMsg, viewLists.responseMsg) &&
        Objects.equals(this.data, viewLists.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewLists
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewLists.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewLists is not found in the empty JSON string", ViewLists.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewLists.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewLists` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewListsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewLists.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewLists' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewLists> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewLists.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewLists>() {
           @Override
           public void write(JsonWriter out, ViewLists value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewLists read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewLists given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewLists
   * @throws IOException if the JSON string is invalid with respect to ViewLists
   */
  public static ViewLists fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewLists.class);
  }

  /**
   * Convert an instance of ViewLists to an JSON string
   *
   * @return JSON string
   */
