...
import org.openapitools.client.model.InboundSms;
...
public class ViewInboundSmsData {
  ...
  @javax.annotation.Nullable
  private List<InboundSms> data = new ArrayList<>();

  public ViewInboundSmsData() {
  }

  public ViewInboundSmsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewInboundSmsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewInboundSmsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewInboundSmsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewInboundSmsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewInboundSmsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewInboundSmsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewInboundSmsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewInboundSmsData data(@javax.annotation.Nullable List<InboundSms> data) {
    this.data = data;
    return this;
  }

  public ViewInboundSmsData addDataItem(InboundSms dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<InboundSms> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<InboundSms> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewInboundSmsData viewInboundSmsData = (ViewInboundSmsData) o;
    return Objects.equals(this.total, viewInboundSmsData.total) &&
        Objects.equals(this.perPage, viewInboundSmsData.perPage) &&
        Objects.equals(this.currentPage, viewInboundSmsData.currentPage) &&
        Objects.equals(this.lastPage, viewInboundSmsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewInboundSmsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewInboundSmsData.prevPageUrl) &&
        Objects.equals(this.from, viewInboundSmsData.from) &&
        Objects.equals(this.to, viewInboundSmsData.to) &&
        Objects.equals(this.data, viewInboundSmsData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewInboundSmsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewInboundSmsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewInboundSmsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewInboundSmsData is not found in the empty JSON string", ViewInboundSmsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewInboundSmsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewInboundSmsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            InboundSms.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewInboundSmsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewInboundSmsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewInboundSmsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewInboundSmsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewInboundSmsData>() {
           @Override
           public void write(JsonWriter out, ViewInboundSmsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewInboundSmsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewInboundSmsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewInboundSmsData
   * @throws IOException if the JSON string is invalid with respect to ViewInboundSmsData
   */
  public static ViewInboundSmsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewInboundSmsData.class);
  }

  /**
   * Convert an instance of ViewInboundSmsData to an JSON string
   *
   * @return JSON string
   */
