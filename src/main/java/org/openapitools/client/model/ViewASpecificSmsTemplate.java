...
import org.openapitools.client.model.ViewASpecificSmsTemplateData;
...
public class ViewASpecificSmsTemplate {
  ...
  @javax.annotation.Nullable
  private ViewASpecificSmsTemplateData data;
  ...
  public ViewASpecificSmsTemplate responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewASpecificSmsTemplate responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewASpecificSmsTemplate data(@javax.annotation.Nullable ViewASpecificSmsTemplateData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewASpecificSmsTemplateData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewASpecificSmsTemplateData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewASpecificSmsTemplate viewASpecificSmsTemplate = (ViewASpecificSmsTemplate) o;
    return Objects.equals(this.httpCode, viewASpecificSmsTemplate.httpCode) &&
        Objects.equals(this.responseCode, viewASpecificSmsTemplate.responseCode) &&
        Objects.equals(this.responseMsg, viewASpecificSmsTemplate.responseMsg) &&
        Objects.equals(this.data, viewASpecificSmsTemplate.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewASpecificSmsTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewASpecificSmsTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewASpecificSmsTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewASpecificSmsTemplate is not found in the empty JSON string", ViewASpecificSmsTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewASpecificSmsTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewASpecificSmsTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewASpecificSmsTemplateData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewASpecificSmsTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewASpecificSmsTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewASpecificSmsTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewASpecificSmsTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewASpecificSmsTemplate>() {
           @Override
           public void write(JsonWriter out, ViewASpecificSmsTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewASpecificSmsTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewASpecificSmsTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewASpecificSmsTemplate
   * @throws IOException if the JSON string is invalid with respect to ViewASpecificSmsTemplate
   */
  public static ViewASpecificSmsTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewASpecificSmsTemplate.class);
  }

  /**
   * Convert an instance of ViewASpecificSmsTemplate to an JSON string
   *
   * @return JSON string
   */
