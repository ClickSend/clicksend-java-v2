...
import org.openapitools.client.model.UserEmailTemplate;
...
public class ViewEmailTemplate {
  ...
  @javax.annotation.Nullable
  private UserEmailTemplate data;

  public ViewEmailTemplate() {
  }

  public ViewEmailTemplate httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewEmailTemplate responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewEmailTemplate responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewEmailTemplate data(@javax.annotation.Nullable UserEmailTemplate data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public UserEmailTemplate getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable UserEmailTemplate data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewEmailTemplate viewEmailTemplate = (ViewEmailTemplate) o;
    return Objects.equals(this.httpCode, viewEmailTemplate.httpCode) &&
        Objects.equals(this.responseCode, viewEmailTemplate.responseCode) &&
        Objects.equals(this.responseMsg, viewEmailTemplate.responseMsg) &&
        Objects.equals(this.data, viewEmailTemplate.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewEmailTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewEmailTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewEmailTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewEmailTemplate is not found in the empty JSON string", ViewEmailTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewEmailTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewEmailTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        UserEmailTemplate.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewEmailTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewEmailTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewEmailTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewEmailTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewEmailTemplate>() {
           @Override
           public void write(JsonWriter out, ViewEmailTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewEmailTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewEmailTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewEmailTemplate
   * @throws IOException if the JSON string is invalid with respect to ViewEmailTemplate
   */
  public static ViewEmailTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewEmailTemplate.class);
  }

  /**
   * Convert an instance of ViewEmailTemplate to an JSON string
   *
   * @return JSON string
   */
