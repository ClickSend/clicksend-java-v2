...
public class CopyContactToList {
  ...
  public CopyContactToList() {
  }

  public CopyContactToList httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CopyContactToList responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CopyContactToList responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CopyContactToList data(@javax.annotation.Nullable Contact data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CopyContactToList copyContactToList = (CopyContactToList) o;
    return Objects.equals(this.httpCode, copyContactToList.httpCode) &&
        Objects.equals(this.responseCode, copyContactToList.responseCode) &&
        Objects.equals(this.responseMsg, copyContactToList.responseMsg) &&
        Objects.equals(this.data, copyContactToList.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CopyContactToList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CopyContactToList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CopyContactToList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CopyContactToList is not found in the empty JSON string", CopyContactToList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CopyContactToList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CopyContactToList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CopyContactToList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CopyContactToList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CopyContactToList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CopyContactToList.class));

       return (TypeAdapter<T>) new TypeAdapter<CopyContactToList>() {
           @Override
           public void write(JsonWriter out, CopyContactToList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CopyContactToList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CopyContactToList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CopyContactToList
   * @throws IOException if the JSON string is invalid with respect to CopyContactToList
   */
  public static CopyContactToList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CopyContactToList.class);
  }

  /**
   * Convert an instance of CopyContactToList to an JSON string
   *
   * @return JSON string
   */
