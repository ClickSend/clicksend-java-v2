...
import org.openapitools.client.model.ViewLetterHistoryData;
...
public class ViewLetterHistory {
  ...
  @javax.annotation.Nullable
  private ViewLetterHistoryData data;

  public ViewLetterHistory() {
  }

  public ViewLetterHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewLetterHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewLetterHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewLetterHistory data(@javax.annotation.Nullable ViewLetterHistoryData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewLetterHistoryData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewLetterHistoryData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewLetterHistory viewLetterHistory = (ViewLetterHistory) o;
    return Objects.equals(this.httpCode, viewLetterHistory.httpCode) &&
        Objects.equals(this.responseCode, viewLetterHistory.responseCode) &&
        Objects.equals(this.responseMsg, viewLetterHistory.responseMsg) &&
        Objects.equals(this.data, viewLetterHistory.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewLetterHistory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewLetterHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewLetterHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewLetterHistory is not found in the empty JSON string", ViewLetterHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewLetterHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewLetterHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewLetterHistoryData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewLetterHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewLetterHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewLetterHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewLetterHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewLetterHistory>() {
           @Override
           public void write(JsonWriter out, ViewLetterHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewLetterHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewLetterHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewLetterHistory
   * @throws IOException if the JSON string is invalid with respect to ViewLetterHistory
   */
  public static ViewLetterHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewLetterHistory.class);
  }

  /**
   * Convert an instance of ViewLetterHistory to an JSON string
   *
   * @return JSON string
   */
