...
import org.openapitools.client.model.ViewAvailableNumbersDataInner;
...
public class ViewAvailableNumbers {
  ...
  public ViewAvailableNumbers httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewAvailableNumbers responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewAvailableNumbers responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public boolean equals(Object o) {
    ...
    ViewAvailableNumbers viewAvailableNumbers = (ViewAvailableNumbers) o;
  ...
  public String toString() {
    ...
    sb.append("class ViewAvailableNumbers {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAvailableNumbers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAvailableNumbers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAvailableNumbers is not found in the empty JSON string", ViewAvailableNumbers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAvailableNumbers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAvailableNumbers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAvailableNumbers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAvailableNumbers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAvailableNumbers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAvailableNumbers.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAvailableNumbers>() {
           @Override
           public void write(JsonWriter out, ViewAvailableNumbers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAvailableNumbers read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAvailableNumbers given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAvailableNumbers
   * @throws IOException if the JSON string is invalid with respect to ViewAvailableNumbers
   */
  public static ViewAvailableNumbers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAvailableNumbers.class);
  }

  /**
   * Convert an instance of ViewAvailableNumbers to an JSON string
   *
   * @return JSON string
   */
