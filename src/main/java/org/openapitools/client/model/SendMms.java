...
public class SendMms {
  ...
  public SendMms httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendMms responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendMms responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendMms data(@javax.annotation.Nullable SendMmsData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendMms sendMms = (SendMms) o;
    return Objects.equals(this.httpCode, sendMms.httpCode) &&
        Objects.equals(this.responseCode, sendMms.responseCode) &&
        Objects.equals(this.responseMsg, sendMms.responseMsg) &&
        Objects.equals(this.data, sendMms.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendMms
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendMms.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendMms is not found in the empty JSON string", SendMms.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendMms.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendMms` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendMms.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendMms' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendMms> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendMms.class));

       return (TypeAdapter<T>) new TypeAdapter<SendMms>() {
           @Override
           public void write(JsonWriter out, SendMms value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendMms read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendMms given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendMms
   * @throws IOException if the JSON string is invalid with respect to SendMms
   */
  public static SendMms fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendMms.class);
  }

  /**
   * Convert an instance of SendMms to an JSON string
   *
   * @return JSON string
   */
