...
public class CreateStrippedStringRule {
  ...
  public CreateStrippedStringRule httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CreateStrippedStringRule responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CreateStrippedStringRule responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public boolean equals(Object o) {
    ...
    CreateStrippedStringRule createStrippedStringRule = (CreateStrippedStringRule) o;
    return Objects.equals(this.httpCode, createStrippedStringRule.httpCode) &&
        Objects.equals(this.responseCode, createStrippedStringRule.responseCode) &&
        Objects.equals(this.responseMsg, createStrippedStringRule.responseMsg) &&
        Objects.equals(this.data, createStrippedStringRule.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateStrippedStringRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateStrippedStringRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateStrippedStringRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateStrippedStringRule is not found in the empty JSON string", CreateStrippedStringRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateStrippedStringRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateStrippedStringRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateStrippedStringRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateStrippedStringRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateStrippedStringRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateStrippedStringRule.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateStrippedStringRule>() {
           @Override
           public void write(JsonWriter out, CreateStrippedStringRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateStrippedStringRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateStrippedStringRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateStrippedStringRule
   * @throws IOException if the JSON string is invalid with respect to CreateStrippedStringRule
   */
  public static CreateStrippedStringRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateStrippedStringRule.class);
  }

  /**
   * Convert an instance of CreateStrippedStringRule to an JSON string
   *
   * @return JSON string
   */
