...
public class SendVoiceMessage {
  ...
  public SendVoiceMessage httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendVoiceMessage responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendVoiceMessage responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendVoiceMessage data(@javax.annotation.Nullable SendVoiceMessageData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendVoiceMessage sendVoiceMessage = (SendVoiceMessage) o;
    return Objects.equals(this.httpCode, sendVoiceMessage.httpCode) &&
        Objects.equals(this.responseCode, sendVoiceMessage.responseCode) &&
        Objects.equals(this.responseMsg, sendVoiceMessage.responseMsg) &&
        Objects.equals(this.data, sendVoiceMessage.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendVoiceMessage {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendVoiceMessage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendVoiceMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendVoiceMessage is not found in the empty JSON string", SendVoiceMessage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendVoiceMessage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendVoiceMessage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendVoiceMessage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendVoiceMessage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendVoiceMessage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendVoiceMessage.class));

       return (TypeAdapter<T>) new TypeAdapter<SendVoiceMessage>() {
           @Override
           public void write(JsonWriter out, SendVoiceMessage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendVoiceMessage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendVoiceMessage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendVoiceMessage
   * @throws IOException if the JSON string is invalid with respect to SendVoiceMessage
   */
  public static SendVoiceMessage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendVoiceMessage.class);
  }

  /**
   * Convert an instance of SendVoiceMessage to an JSON string
   *
   * @return JSON string
   */
