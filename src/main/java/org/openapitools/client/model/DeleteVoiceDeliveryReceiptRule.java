...
public class DeleteVoiceDeliveryReceiptRule {
  ...
  public DeleteVoiceDeliveryReceiptRule() {
  }

  public DeleteVoiceDeliveryReceiptRule httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteVoiceDeliveryReceiptRule responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteVoiceDeliveryReceiptRule responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteVoiceDeliveryReceiptRule data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteVoiceDeliveryReceiptRule addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteVoiceDeliveryReceiptRule deleteVoiceDeliveryReceiptRule = (DeleteVoiceDeliveryReceiptRule) o;
    return Objects.equals(this.httpCode, deleteVoiceDeliveryReceiptRule.httpCode) &&
        Objects.equals(this.responseCode, deleteVoiceDeliveryReceiptRule.responseCode) &&
        Objects.equals(this.responseMsg, deleteVoiceDeliveryReceiptRule.responseMsg) &&
        Objects.equals(this.data, deleteVoiceDeliveryReceiptRule.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteVoiceDeliveryReceiptRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteVoiceDeliveryReceiptRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteVoiceDeliveryReceiptRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteVoiceDeliveryReceiptRule is not found in the empty JSON string", DeleteVoiceDeliveryReceiptRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteVoiceDeliveryReceiptRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteVoiceDeliveryReceiptRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteVoiceDeliveryReceiptRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteVoiceDeliveryReceiptRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteVoiceDeliveryReceiptRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteVoiceDeliveryReceiptRule.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteVoiceDeliveryReceiptRule>() {
           @Override
           public void write(JsonWriter out, DeleteVoiceDeliveryReceiptRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteVoiceDeliveryReceiptRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteVoiceDeliveryReceiptRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteVoiceDeliveryReceiptRule
   * @throws IOException if the JSON string is invalid with respect to DeleteVoiceDeliveryReceiptRule
   */
  public static DeleteVoiceDeliveryReceiptRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteVoiceDeliveryReceiptRule.class);
  }

  /**
   * Convert an instance of DeleteVoiceDeliveryReceiptRule to an JSON string
   *
   * @return JSON string
   */
