...
import org.openapitools.client.model.ViewInboundSmsData;
...
public class ViewInboundSms {
  ...
  @javax.annotation.Nullable
  private ViewInboundSmsData data;

  public ViewInboundSms() {
  }

  public ViewInboundSms httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewInboundSms responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewInboundSms responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewInboundSms data(@javax.annotation.Nullable ViewInboundSmsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewInboundSmsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewInboundSmsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewInboundSms viewInboundSms = (ViewInboundSms) o;
    return Objects.equals(this.httpCode, viewInboundSms.httpCode) &&
        Objects.equals(this.responseCode, viewInboundSms.responseCode) &&
        Objects.equals(this.responseMsg, viewInboundSms.responseMsg) &&
        Objects.equals(this.data, viewInboundSms.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewInboundSms {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewInboundSms
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewInboundSms.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewInboundSms is not found in the empty JSON string", ViewInboundSms.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewInboundSms.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewInboundSms` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewInboundSmsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewInboundSms.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewInboundSms' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewInboundSms> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewInboundSms.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewInboundSms>() {
           @Override
           public void write(JsonWriter out, ViewInboundSms value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewInboundSms read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewInboundSms given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewInboundSms
   * @throws IOException if the JSON string is invalid with respect to ViewInboundSms
   */
  public static ViewInboundSms fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewInboundSms.class);
  }

  /**
   * Convert an instance of ViewInboundSms to an JSON string
   *
   * @return JSON string
   */
