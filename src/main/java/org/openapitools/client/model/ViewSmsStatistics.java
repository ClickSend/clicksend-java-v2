...
import org.openapitools.client.model.ViewSmsStatisticsData;
...
public class ViewSmsStatistics {
  ...
  @javax.annotation.Nullable
  private ViewSmsStatisticsData data;

  public ViewSmsStatistics() {
  }

  public ViewSmsStatistics httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewSmsStatistics responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewSmsStatistics responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewSmsStatistics data(@javax.annotation.Nullable ViewSmsStatisticsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewSmsStatisticsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewSmsStatisticsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSmsStatistics viewSmsStatistics = (ViewSmsStatistics) o;
    return Objects.equals(this.httpCode, viewSmsStatistics.httpCode) &&
        Objects.equals(this.responseCode, viewSmsStatistics.responseCode) &&
        Objects.equals(this.responseMsg, viewSmsStatistics.responseMsg) &&
        Objects.equals(this.data, viewSmsStatistics.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSmsStatistics {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSmsStatistics
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSmsStatistics.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSmsStatistics is not found in the empty JSON string", ViewSmsStatistics.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSmsStatistics.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSmsStatistics` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewSmsStatisticsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSmsStatistics.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSmsStatistics' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSmsStatistics> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSmsStatistics.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSmsStatistics>() {
           @Override
           public void write(JsonWriter out, ViewSmsStatistics value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSmsStatistics read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSmsStatistics given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSmsStatistics
   * @throws IOException if the JSON string is invalid with respect to ViewSmsStatistics
   */
  public static ViewSmsStatistics fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSmsStatistics.class);
  }

  /**
   * Convert an instance of ViewSmsStatistics to an JSON string
   *
   * @return JSON string
   */
