...
public class Fields {
  ...
  private FieldsFields fields;

  public Fields() {
    this.classType = this.getClass().getSimpleName();
  }

  public Fields fields(@javax.annotation.Nullable FieldsFields fields) {
    this.fields = fields;
    return this;
  }
  ...
  public void setFields(@javax.annotation.Nullable FieldsFields fields) {
    this.fields = fields;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Fields.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in Fields is not found in the empty JSON string", Fields.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Fields.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Fields` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  }
