...
import org.openapitools.client.model.SmsReceipt;
...
public class ViewSmsReceiptsData {
  ...
  @javax.annotation.Nullable
  private List<SmsReceipt> data = new ArrayList<>();

  public ViewSmsReceiptsData() {
  }

  public ViewSmsReceiptsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewSmsReceiptsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewSmsReceiptsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewSmsReceiptsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewSmsReceiptsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewSmsReceiptsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewSmsReceiptsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewSmsReceiptsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewSmsReceiptsData data(@javax.annotation.Nullable List<SmsReceipt> data) {
    this.data = data;
    return this;
  }

  public ViewSmsReceiptsData addDataItem(SmsReceipt dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<SmsReceipt> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<SmsReceipt> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSmsReceiptsData viewSmsReceiptsData = (ViewSmsReceiptsData) o;
    return Objects.equals(this.total, viewSmsReceiptsData.total) &&
        Objects.equals(this.perPage, viewSmsReceiptsData.perPage) &&
        Objects.equals(this.currentPage, viewSmsReceiptsData.currentPage) &&
        Objects.equals(this.lastPage, viewSmsReceiptsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewSmsReceiptsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewSmsReceiptsData.prevPageUrl) &&
        Objects.equals(this.from, viewSmsReceiptsData.from) &&
        Objects.equals(this.to, viewSmsReceiptsData.to) &&
        Objects.equals(this.data, viewSmsReceiptsData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSmsReceiptsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSmsReceiptsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSmsReceiptsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSmsReceiptsData is not found in the empty JSON string", ViewSmsReceiptsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSmsReceiptsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSmsReceiptsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            SmsReceipt.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSmsReceiptsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSmsReceiptsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSmsReceiptsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSmsReceiptsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSmsReceiptsData>() {
           @Override
           public void write(JsonWriter out, ViewSmsReceiptsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSmsReceiptsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSmsReceiptsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSmsReceiptsData
   * @throws IOException if the JSON string is invalid with respect to ViewSmsReceiptsData
   */
  public static ViewSmsReceiptsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSmsReceiptsData.class);
  }

  /**
   * Convert an instance of ViewSmsReceiptsData to an JSON string
   *
   * @return JSON string
   */
