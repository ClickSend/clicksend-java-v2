...
public class CreateList {
  ...
  public CreateList httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CreateList responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CreateList responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CreateList data(@javax.annotation.Nullable ContactList data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, createList.httpCode) &&
        Objects.equals(this.responseCode, createList.responseCode) &&
        Objects.equals(this.responseMsg, createList.responseMsg) &&
        Objects.equals(this.data, createList.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateList is not found in the empty JSON string", CreateList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateList.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateList>() {
           @Override
           public void write(JsonWriter out, CreateList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateList
   * @throws IOException if the JSON string is invalid with respect to CreateList
   */
  public static CreateList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateList.class);
  }

  /**
   * Convert an instance of CreateList to an JSON string
   *
   * @return JSON string
   */
