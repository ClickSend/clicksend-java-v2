...
import org.openapitools.client.model.TransactionalEmail;
...
public class CalculateEmailPriceData {
  ...
  public CalculateEmailPriceData() {
  }

  public CalculateEmailPriceData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public CalculateEmailPriceData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public CalculateEmailPriceData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public CalculateEmailPriceData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public CalculateEmailPriceData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public CalculateEmailPriceData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public CalculateEmailPriceData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public CalculateEmailPriceData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CalculateEmailPriceData calculateEmailPriceData = (CalculateEmailPriceData) o;
    return Objects.equals(this.total, calculateEmailPriceData.total) &&
        Objects.equals(this.perPage, calculateEmailPriceData.perPage) &&
        Objects.equals(this.currentPage, calculateEmailPriceData.currentPage) &&
        Objects.equals(this.lastPage, calculateEmailPriceData.lastPage) &&
        Objects.equals(this.nextPageUrl, calculateEmailPriceData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, calculateEmailPriceData.prevPageUrl) &&
        Objects.equals(this.from, calculateEmailPriceData.from) &&
        Objects.equals(this.to, calculateEmailPriceData.to);
  }
  ...
  public String toString() {
    ...
    sb.append("class CalculateEmailPriceData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateEmailPriceData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateEmailPriceData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CalculateEmailPriceData is not found in the empty JSON string", CalculateEmailPriceData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateEmailPriceData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CalculateEmailPriceData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CalculateEmailPriceData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CalculateEmailPriceData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CalculateEmailPriceData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CalculateEmailPriceData.class));

       return (TypeAdapter<T>) new TypeAdapter<CalculateEmailPriceData>() {
           @Override
           public void write(JsonWriter out, CalculateEmailPriceData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CalculateEmailPriceData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CalculateEmailPriceData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CalculateEmailPriceData
   * @throws IOException if the JSON string is invalid with respect to CalculateEmailPriceData
   */
  public static CalculateEmailPriceData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CalculateEmailPriceData.class);
  }

  /**
   * Convert an instance of CalculateEmailPriceData to an JSON string
   *
   * @return JSON string
   */
