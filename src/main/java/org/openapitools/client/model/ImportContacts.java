...
import org.openapitools.client.model.ImportContactsData;
...
public class ImportContacts {
  ...
  @javax.annotation.Nullable
  private ImportContactsData data;

  public ImportContacts() {
  }

  public ImportContacts httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ImportContacts responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ImportContacts responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ImportContacts data(@javax.annotation.Nullable ImportContactsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ImportContactsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ImportContactsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ImportContacts importContacts = (ImportContacts) o;
    return Objects.equals(this.httpCode, importContacts.httpCode) &&
        Objects.equals(this.responseCode, importContacts.responseCode) &&
        Objects.equals(this.responseMsg, importContacts.responseMsg) &&
        Objects.equals(this.data, importContacts.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ImportContacts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ImportContacts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ImportContacts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ImportContacts is not found in the empty JSON string", ImportContacts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ImportContacts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ImportContacts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ImportContactsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ImportContacts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ImportContacts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ImportContacts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ImportContacts.class));

       return (TypeAdapter<T>) new TypeAdapter<ImportContacts>() {
           @Override
           public void write(JsonWriter out, ImportContacts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ImportContacts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ImportContacts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ImportContacts
   * @throws IOException if the JSON string is invalid with respect to ImportContacts
   */
  public static ImportContacts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ImportContacts.class);
  }

  /**
   * Convert an instance of ImportContacts to an JSON string
   *
   * @return JSON string
   */
