...
public class SendSmsCampaign {
  ...
  public SendSmsCampaign() {
  }

  public SendSmsCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendSmsCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendSmsCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendSmsCampaign data(@javax.annotation.Nullable SmsCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendSmsCampaign sendSmsCampaign = (SendSmsCampaign) o;
    return Objects.equals(this.httpCode, sendSmsCampaign.httpCode) &&
        Objects.equals(this.responseCode, sendSmsCampaign.responseCode) &&
        Objects.equals(this.responseMsg, sendSmsCampaign.responseMsg) &&
        Objects.equals(this.data, sendSmsCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendSmsCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendSmsCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendSmsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendSmsCampaign is not found in the empty JSON string", SendSmsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendSmsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendSmsCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendSmsCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendSmsCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendSmsCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendSmsCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<SendSmsCampaign>() {
           @Override
           public void write(JsonWriter out, SendSmsCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendSmsCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendSmsCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendSmsCampaign
   * @throws IOException if the JSON string is invalid with respect to SendSmsCampaign
   */
  public static SendSmsCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendSmsCampaign.class);
  }

  /**
   * Convert an instance of SendSmsCampaign to an JSON string
   *
   * @return JSON string
   */
