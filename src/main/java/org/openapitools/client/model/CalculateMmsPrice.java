...
import org.openapitools.client.model.SendMmsData;
...
public class CalculateMmsPrice {
  ...
  @javax.annotation.Nullable
  private SendMmsData data;

  public CalculateMmsPrice() {
  }

  public CalculateMmsPrice httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CalculateMmsPrice responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CalculateMmsPrice responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CalculateMmsPrice data(@javax.annotation.Nullable SendMmsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SendMmsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable SendMmsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CalculateMmsPrice calculateMmsPrice = (CalculateMmsPrice) o;
    return Objects.equals(this.httpCode, calculateMmsPrice.httpCode) &&
        Objects.equals(this.responseCode, calculateMmsPrice.responseCode) &&
        Objects.equals(this.responseMsg, calculateMmsPrice.responseMsg) &&
        Objects.equals(this.data, calculateMmsPrice.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CalculateMmsPrice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateMmsPrice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateMmsPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CalculateMmsPrice is not found in the empty JSON string", CalculateMmsPrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateMmsPrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CalculateMmsPrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        SendMmsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CalculateMmsPrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CalculateMmsPrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CalculateMmsPrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CalculateMmsPrice.class));

       return (TypeAdapter<T>) new TypeAdapter<CalculateMmsPrice>() {
           @Override
           public void write(JsonWriter out, CalculateMmsPrice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CalculateMmsPrice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CalculateMmsPrice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CalculateMmsPrice
   * @throws IOException if the JSON string is invalid with respect to CalculateMmsPrice
   */
  public static CalculateMmsPrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CalculateMmsPrice.class);
  }

  /**
   * Convert an instance of CalculateMmsPrice to an JSON string
   *
   * @return JSON string
   */
