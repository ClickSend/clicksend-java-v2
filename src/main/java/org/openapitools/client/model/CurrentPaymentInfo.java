...
import org.openapitools.client.model.CurrentPaymentInfoData;
...
public class CurrentPaymentInfo {
  ...
  @javax.annotation.Nullable
  private CurrentPaymentInfoData data;

  public CurrentPaymentInfo() {
  }

  public CurrentPaymentInfo httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CurrentPaymentInfo responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CurrentPaymentInfo responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CurrentPaymentInfo data(@javax.annotation.Nullable CurrentPaymentInfoData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CurrentPaymentInfoData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable CurrentPaymentInfoData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CurrentPaymentInfo currentPaymentInfo = (CurrentPaymentInfo) o;
    return Objects.equals(this.httpCode, currentPaymentInfo.httpCode) &&
        Objects.equals(this.responseCode, currentPaymentInfo.responseCode) &&
        Objects.equals(this.responseMsg, currentPaymentInfo.responseMsg) &&
        Objects.equals(this.data, currentPaymentInfo.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrentPaymentInfo {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CurrentPaymentInfo
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CurrentPaymentInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CurrentPaymentInfo is not found in the empty JSON string", CurrentPaymentInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrentPaymentInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CurrentPaymentInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CurrentPaymentInfoData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CurrentPaymentInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CurrentPaymentInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CurrentPaymentInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CurrentPaymentInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<CurrentPaymentInfo>() {
           @Override
           public void write(JsonWriter out, CurrentPaymentInfo value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CurrentPaymentInfo read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CurrentPaymentInfo given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CurrentPaymentInfo
   * @throws IOException if the JSON string is invalid with respect to CurrentPaymentInfo
   */
  public static CurrentPaymentInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CurrentPaymentInfo.class);
  }

  /**
   * Convert an instance of CurrentPaymentInfo to an JSON string
   *
   * @return JSON string
   */
