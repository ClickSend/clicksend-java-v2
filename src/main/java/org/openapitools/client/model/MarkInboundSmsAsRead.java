...
public class MarkInboundSmsAsRead {
  ...
  public MarkInboundSmsAsRead() {
  }

  public MarkInboundSmsAsRead httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public MarkInboundSmsAsRead responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public MarkInboundSmsAsRead responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public MarkInboundSmsAsRead data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MarkInboundSmsAsRead markInboundSmsAsRead = (MarkInboundSmsAsRead) o;
    return Objects.equals(this.httpCode, markInboundSmsAsRead.httpCode) &&
        Objects.equals(this.responseCode, markInboundSmsAsRead.responseCode) &&
        Objects.equals(this.responseMsg, markInboundSmsAsRead.responseMsg) &&
        Objects.equals(this.data, markInboundSmsAsRead.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MarkInboundSmsAsRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MarkInboundSmsAsRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MarkInboundSmsAsRead is not found in the empty JSON string", MarkInboundSmsAsRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MarkInboundSmsAsRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MarkInboundSmsAsRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MarkInboundSmsAsRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MarkInboundSmsAsRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MarkInboundSmsAsRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MarkInboundSmsAsRead.class));

       return (TypeAdapter<T>) new TypeAdapter<MarkInboundSmsAsRead>() {
           @Override
           public void write(JsonWriter out, MarkInboundSmsAsRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MarkInboundSmsAsRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MarkInboundSmsAsRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MarkInboundSmsAsRead
   * @throws IOException if the JSON string is invalid with respect to MarkInboundSmsAsRead
   */
  public static MarkInboundSmsAsRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MarkInboundSmsAsRead.class);
  }

  /**
   * Convert an instance of MarkInboundSmsAsRead to an JSON string
   *
   * @return JSON string
   */
