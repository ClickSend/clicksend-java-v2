...
public class UpdateSmsCampaign {
  ...
  public UpdateSmsCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdateSmsCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateSmsCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateSmsCampaign data(@javax.annotation.Nullable SmsCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, updateSmsCampaign.httpCode) &&
        Objects.equals(this.responseCode, updateSmsCampaign.responseCode) &&
        Objects.equals(this.responseMsg, updateSmsCampaign.responseMsg) &&
        Objects.equals(this.data, updateSmsCampaign.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSmsCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSmsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateSmsCampaign is not found in the empty JSON string", UpdateSmsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSmsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateSmsCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSmsCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSmsCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSmsCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSmsCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSmsCampaign>() {
           @Override
           public void write(JsonWriter out, UpdateSmsCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSmsCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSmsCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSmsCampaign
   * @throws IOException if the JSON string is invalid with respect to UpdateSmsCampaign
   */
  public static UpdateSmsCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSmsCampaign.class);
  }

  /**
   * Convert an instance of UpdateSmsCampaign to an JSON string
   *
   * @return JSON string
   */
