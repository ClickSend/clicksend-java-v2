...
import org.openapitools.client.model.ViewVoiceLanguagesDataInner;
...
public class ViewVoiceLanguages {
  ...
  @javax.annotation.Nullable
  private List<ViewVoiceLanguagesDataInner> data = new ArrayList<>();

  public ViewVoiceLanguages() {
  }

  public ViewVoiceLanguages httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewVoiceLanguages responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewVoiceLanguages responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewVoiceLanguages data(@javax.annotation.Nullable List<ViewVoiceLanguagesDataInner> data) {
    this.data = data;
    return this;
  }

  public ViewVoiceLanguages addDataItem(ViewVoiceLanguagesDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ViewVoiceLanguagesDataInner> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ViewVoiceLanguagesDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewVoiceLanguages viewVoiceLanguages = (ViewVoiceLanguages) o;
    return Objects.equals(this.httpCode, viewVoiceLanguages.httpCode) &&
        Objects.equals(this.responseCode, viewVoiceLanguages.responseCode) &&
        Objects.equals(this.responseMsg, viewVoiceLanguages.responseMsg) &&
        Objects.equals(this.data, viewVoiceLanguages.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewVoiceLanguages {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewVoiceLanguages
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewVoiceLanguages.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewVoiceLanguages is not found in the empty JSON string", ViewVoiceLanguages.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewVoiceLanguages.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewVoiceLanguages` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ViewVoiceLanguagesDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewVoiceLanguages.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewVoiceLanguages' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewVoiceLanguages> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewVoiceLanguages.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewVoiceLanguages>() {
           @Override
           public void write(JsonWriter out, ViewVoiceLanguages value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewVoiceLanguages read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewVoiceLanguages given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewVoiceLanguages
   * @throws IOException if the JSON string is invalid with respect to ViewVoiceLanguages
   */
  public static ViewVoiceLanguages fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewVoiceLanguages.class);
  }

  /**
   * Convert an instance of ViewVoiceLanguages to an JSON string
   *
   * @return JSON string
   */
