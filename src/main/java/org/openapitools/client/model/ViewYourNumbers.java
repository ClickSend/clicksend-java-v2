...
import org.openapitools.client.model.ViewYourNumbersData;
...
public class ViewYourNumbers {
  ...
  @javax.annotation.Nullable
  private ViewYourNumbersData data;

  public ViewYourNumbers() {
  }

  public ViewYourNumbers httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewYourNumbers responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewYourNumbers responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewYourNumbers data(@javax.annotation.Nullable ViewYourNumbersData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewYourNumbersData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewYourNumbersData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewYourNumbers viewYourNumbers = (ViewYourNumbers) o;
    return Objects.equals(this.httpCode, viewYourNumbers.httpCode) &&
        Objects.equals(this.responseCode, viewYourNumbers.responseCode) &&
        Objects.equals(this.responseMsg, viewYourNumbers.responseMsg) &&
        Objects.equals(this.data, viewYourNumbers.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewYourNumbers {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewYourNumbers
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewYourNumbers.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewYourNumbers is not found in the empty JSON string", ViewYourNumbers.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewYourNumbers.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewYourNumbers` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewYourNumbersData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewYourNumbers.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewYourNumbers' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewYourNumbers> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewYourNumbers.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewYourNumbers>() {
           @Override
           public void write(JsonWriter out, ViewYourNumbers value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewYourNumbers read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewYourNumbers given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewYourNumbers
   * @throws IOException if the JSON string is invalid with respect to ViewYourNumbers
   */
  public static ViewYourNumbers fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewYourNumbers.class);
  }

  /**
   * Convert an instance of ViewYourNumbers to an JSON string
   *
   * @return JSON string
   */
