...
import org.openapitools.client.model.SendEmailRequestAttachmentsInner;
...
public class SendEmailRequest {
  ...
  @javax.annotation.Nullable
  private List<SendEmailRequestAttachmentsInner> attachments = new ArrayList<>();

  public SendEmailRequest() {
  }

  public SendEmailRequest to(@javax.annotation.Nullable List<SendEmailRequestToInner> to) {
    this.to = to;
    return this;
  }

  public SendEmailRequest addToItem(SendEmailRequestToInner toItem) {
    if (this.to == null) {
  ...
  public SendEmailRequest from(@javax.annotation.Nullable SendEmailRequestFrom from) {
    this.from = from;
    return this;
  }
  ...
  public SendEmailRequest body(@javax.annotation.Nullable String body) {
    this.body = body;
    return this;
  }
  ...
  public SendEmailRequest attachments(@javax.annotation.Nullable List<SendEmailRequestAttachmentsInner> attachments) {
    this.attachments = attachments;
    return this;
  }

  public SendEmailRequest addAttachmentsItem(SendEmailRequestAttachmentsInner attachmentsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<SendEmailRequestAttachmentsInner> getAttachments() {
    return attachments;
  }

  public void setAttachments(@javax.annotation.Nullable List<SendEmailRequestAttachmentsInner> attachments) {
    this.attachments = attachments;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(to, from, subject, body, attachments);
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("to", "from", "subject", "body", "attachments"));
      ...
      if (jsonObj.get("attachments") != null && !jsonObj.get("attachments").isJsonNull()) {
        ...
        if (jsonArrayattachments != null) {
          ...
          for (int i = 0; i < jsonArrayattachments.size(); i++) {
            SendEmailRequestAttachmentsInner.validateJsonElement(jsonArrayattachments.get(i));
          };
        }
      }
  }
