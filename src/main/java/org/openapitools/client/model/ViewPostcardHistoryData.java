...
public class ViewPostcardHistoryData {
  ...
  @javax.annotation.Nullable
  private List<PostcardRecipient> data = new ArrayList<>();

  public ViewPostcardHistoryData() {
  }

  public ViewPostcardHistoryData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewPostcardHistoryData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewPostcardHistoryData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewPostcardHistoryData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewPostcardHistoryData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewPostcardHistoryData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewPostcardHistoryData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewPostcardHistoryData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewPostcardHistoryData data(@javax.annotation.Nullable List<PostcardRecipient> data) {
    this.data = data;
    return this;
  }

  public ViewPostcardHistoryData addDataItem(PostcardRecipient dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<PostcardRecipient> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<PostcardRecipient> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewPostcardHistoryData viewPostcardHistoryData = (ViewPostcardHistoryData) o;
    return Objects.equals(this.total, viewPostcardHistoryData.total) &&
        Objects.equals(this.perPage, viewPostcardHistoryData.perPage) &&
        Objects.equals(this.currentPage, viewPostcardHistoryData.currentPage) &&
        Objects.equals(this.lastPage, viewPostcardHistoryData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewPostcardHistoryData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewPostcardHistoryData.prevPageUrl) &&
        Objects.equals(this.from, viewPostcardHistoryData.from) &&
        Objects.equals(this.to, viewPostcardHistoryData.to) &&
        Objects.equals(this.data, viewPostcardHistoryData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewPostcardHistoryData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewPostcardHistoryData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewPostcardHistoryData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewPostcardHistoryData is not found in the empty JSON string", ViewPostcardHistoryData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewPostcardHistoryData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewPostcardHistoryData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            PostcardRecipient.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewPostcardHistoryData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewPostcardHistoryData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewPostcardHistoryData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewPostcardHistoryData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewPostcardHistoryData>() {
           @Override
           public void write(JsonWriter out, ViewPostcardHistoryData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewPostcardHistoryData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewPostcardHistoryData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewPostcardHistoryData
   * @throws IOException if the JSON string is invalid with respect to ViewPostcardHistoryData
   */
  public static ViewPostcardHistoryData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewPostcardHistoryData.class);
  }

  /**
   * Convert an instance of ViewPostcardHistoryData to an JSON string
   *
   * @return JSON string
   */
