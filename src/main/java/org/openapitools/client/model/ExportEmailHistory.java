...
public class ExportEmailHistory {
  ...
  public ExportEmailHistory() {
  }

  public ExportEmailHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ExportEmailHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ExportEmailHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ExportEmailHistory data(@javax.annotation.Nullable ExportSmsHistoryData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportEmailHistory exportEmailHistory = (ExportEmailHistory) o;
    return Objects.equals(this.httpCode, exportEmailHistory.httpCode) &&
        Objects.equals(this.responseCode, exportEmailHistory.responseCode) &&
        Objects.equals(this.responseMsg, exportEmailHistory.responseMsg) &&
        Objects.equals(this.data, exportEmailHistory.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportEmailHistory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportEmailHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportEmailHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExportEmailHistory is not found in the empty JSON string", ExportEmailHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportEmailHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ExportEmailHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportEmailHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportEmailHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportEmailHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportEmailHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportEmailHistory>() {
           @Override
           public void write(JsonWriter out, ExportEmailHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportEmailHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportEmailHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportEmailHistory
   * @throws IOException if the JSON string is invalid with respect to ExportEmailHistory
   */
  public static ExportEmailHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportEmailHistory.class);
  }

  /**
   * Convert an instance of ExportEmailHistory to an JSON string
   *
   * @return JSON string
   */
