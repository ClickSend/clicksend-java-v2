...
public class ViewFaxInboundRulesData {
  ...
  @javax.annotation.Nullable
  private List<InboundFaxRule> data = new ArrayList<>();

  public ViewFaxInboundRulesData() {
  }

  public ViewFaxInboundRulesData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewFaxInboundRulesData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewFaxInboundRulesData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewFaxInboundRulesData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewFaxInboundRulesData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewFaxInboundRulesData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewFaxInboundRulesData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewFaxInboundRulesData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewFaxInboundRulesData data(@javax.annotation.Nullable List<InboundFaxRule> data) {
    this.data = data;
    return this;
  }

  public ViewFaxInboundRulesData addDataItem(InboundFaxRule dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<InboundFaxRule> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<InboundFaxRule> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewFaxInboundRulesData viewFaxInboundRulesData = (ViewFaxInboundRulesData) o;
    return Objects.equals(this.total, viewFaxInboundRulesData.total) &&
        Objects.equals(this.perPage, viewFaxInboundRulesData.perPage) &&
        Objects.equals(this.currentPage, viewFaxInboundRulesData.currentPage) &&
        Objects.equals(this.lastPage, viewFaxInboundRulesData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewFaxInboundRulesData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewFaxInboundRulesData.prevPageUrl) &&
        Objects.equals(this.from, viewFaxInboundRulesData.from) &&
        Objects.equals(this.to, viewFaxInboundRulesData.to) &&
        Objects.equals(this.data, viewFaxInboundRulesData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewFaxInboundRulesData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewFaxInboundRulesData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewFaxInboundRulesData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewFaxInboundRulesData is not found in the empty JSON string", ViewFaxInboundRulesData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewFaxInboundRulesData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewFaxInboundRulesData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            InboundFaxRule.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewFaxInboundRulesData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewFaxInboundRulesData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewFaxInboundRulesData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewFaxInboundRulesData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewFaxInboundRulesData>() {
           @Override
           public void write(JsonWriter out, ViewFaxInboundRulesData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewFaxInboundRulesData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewFaxInboundRulesData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewFaxInboundRulesData
   * @throws IOException if the JSON string is invalid with respect to ViewFaxInboundRulesData
   */
  public static ViewFaxInboundRulesData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewFaxInboundRulesData.class);
  }

  /**
   * Convert an instance of ViewFaxInboundRulesData to an JSON string
   *
   * @return JSON string
   */
