...
import org.openapitools.client.model.SmsTemplateUpdate;
...
public class UpdateSmsTemplate {
  ...
  @javax.annotation.Nullable
  private SmsTemplateUpdate data;

  public UpdateSmsTemplate() {
  }

  public UpdateSmsTemplate httpCode(@javax.annotation.Nullable String httpCode) {
  ...
  public UpdateSmsTemplate responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateSmsTemplate responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateSmsTemplate data(@javax.annotation.Nullable SmsTemplateUpdate data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SmsTemplateUpdate getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable SmsTemplateUpdate data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateSmsTemplate updateSmsTemplate = (UpdateSmsTemplate) o;
    return Objects.equals(this.httpCode, updateSmsTemplate.httpCode) &&
        Objects.equals(this.responseCode, updateSmsTemplate.responseCode) &&
        Objects.equals(this.responseMsg, updateSmsTemplate.responseMsg) &&
        Objects.equals(this.data, updateSmsTemplate.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSmsTemplate {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSmsTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSmsTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateSmsTemplate is not found in the empty JSON string", UpdateSmsTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSmsTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateSmsTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        SmsTemplateUpdate.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSmsTemplate.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSmsTemplate' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSmsTemplate> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSmsTemplate.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSmsTemplate>() {
           @Override
           public void write(JsonWriter out, UpdateSmsTemplate value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSmsTemplate read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSmsTemplate given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSmsTemplate
   * @throws IOException if the JSON string is invalid with respect to UpdateSmsTemplate
   */
  public static UpdateSmsTemplate fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSmsTemplate.class);
  }

  /**
   * Convert an instance of UpdateSmsTemplate to an JSON string
   *
   * @return JSON string
   */
