...
import org.openapitools.client.model.ViewVoiceReceiptsData;
...
public class ViewVoiceReceipts {
  ...
  @javax.annotation.Nullable
  private ViewVoiceReceiptsData data;

  public ViewVoiceReceipts() {
  }

  public ViewVoiceReceipts httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewVoiceReceipts responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewVoiceReceipts responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewVoiceReceipts data(@javax.annotation.Nullable ViewVoiceReceiptsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewVoiceReceiptsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewVoiceReceiptsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewVoiceReceipts viewVoiceReceipts = (ViewVoiceReceipts) o;
    return Objects.equals(this.httpCode, viewVoiceReceipts.httpCode) &&
        Objects.equals(this.responseCode, viewVoiceReceipts.responseCode) &&
        Objects.equals(this.responseMsg, viewVoiceReceipts.responseMsg) &&
        Objects.equals(this.data, viewVoiceReceipts.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewVoiceReceipts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewVoiceReceipts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewVoiceReceipts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewVoiceReceipts is not found in the empty JSON string", ViewVoiceReceipts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewVoiceReceipts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewVoiceReceipts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewVoiceReceiptsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewVoiceReceipts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewVoiceReceipts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewVoiceReceipts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewVoiceReceipts.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewVoiceReceipts>() {
           @Override
           public void write(JsonWriter out, ViewVoiceReceipts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewVoiceReceipts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewVoiceReceipts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewVoiceReceipts
   * @throws IOException if the JSON string is invalid with respect to ViewVoiceReceipts
   */
  public static ViewVoiceReceipts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewVoiceReceipts.class);
  }

  /**
   * Convert an instance of ViewVoiceReceipts to an JSON string
   *
   * @return JSON string
   */
