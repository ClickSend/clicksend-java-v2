...
public class UpdateMmsCampaign {
  ...
  public UpdateMmsCampaign() {
  }

  public UpdateMmsCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdateMmsCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateMmsCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateMmsCampaign data(@javax.annotation.Nullable MmsCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateMmsCampaign updateMmsCampaign = (UpdateMmsCampaign) o;
    return Objects.equals(this.httpCode, updateMmsCampaign.httpCode) &&
        Objects.equals(this.responseCode, updateMmsCampaign.responseCode) &&
        Objects.equals(this.responseMsg, updateMmsCampaign.responseMsg) &&
        Objects.equals(this.data, updateMmsCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateMmsCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateMmsCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateMmsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateMmsCampaign is not found in the empty JSON string", UpdateMmsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateMmsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateMmsCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateMmsCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateMmsCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateMmsCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateMmsCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateMmsCampaign>() {
           @Override
           public void write(JsonWriter out, UpdateMmsCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateMmsCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateMmsCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateMmsCampaign
   * @throws IOException if the JSON string is invalid with respect to UpdateMmsCampaign
   */
  public static UpdateMmsCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateMmsCampaign.class);
  }

  /**
   * Convert an instance of UpdateMmsCampaign to an JSON string
   *
   * @return JSON string
   */
