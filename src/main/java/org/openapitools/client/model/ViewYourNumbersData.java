...
import org.openapitools.client.model.ViewYourNumbersDataAllOfDataInner;
...
public class ViewYourNumbersData {
  ...
  public ViewYourNumbersData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewYourNumbersData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewYourNumbersData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewYourNumbersData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewYourNumbersData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewYourNumbersData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewYourNumbersData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewYourNumbersData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewYourNumbersData data(@javax.annotation.Nullable List<ViewYourNumbersDataAllOfDataInner> data) {
    this.data = data;
    return this;
  }

  public ViewYourNumbersData addDataItem(ViewYourNumbersDataAllOfDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ViewYourNumbersDataAllOfDataInner> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ViewYourNumbersDataAllOfDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewYourNumbersData viewYourNumbersData = (ViewYourNumbersData) o;
    return Objects.equals(this.total, viewYourNumbersData.total) &&
        Objects.equals(this.perPage, viewYourNumbersData.perPage) &&
        Objects.equals(this.currentPage, viewYourNumbersData.currentPage) &&
        Objects.equals(this.lastPage, viewYourNumbersData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewYourNumbersData.nextPageUrl) &&
  ...
  public String toString() {
    ...
    sb.append("class ViewYourNumbersData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewYourNumbersData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewYourNumbersData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewYourNumbersData is not found in the empty JSON string", ViewYourNumbersData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewYourNumbersData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewYourNumbersData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewYourNumbersData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewYourNumbersData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewYourNumbersData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewYourNumbersData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewYourNumbersData>() {
           @Override
           public void write(JsonWriter out, ViewYourNumbersData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewYourNumbersData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewYourNumbersData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewYourNumbersData
   * @throws IOException if the JSON string is invalid with respect to ViewYourNumbersData
   */
  public static ViewYourNumbersData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewYourNumbersData.class);
  }

  /**
   * Convert an instance of ViewYourNumbersData to an JSON string
   *
   * @return JSON string
   */
