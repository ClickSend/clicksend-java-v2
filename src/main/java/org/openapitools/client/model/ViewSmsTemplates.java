...
import org.openapitools.client.model.ViewSmsTemplatesData;
...
public class ViewSmsTemplates {
  ...
  @javax.annotation.Nullable
  private ViewSmsTemplatesData data;

  public ViewSmsTemplates() {
  }

  public ViewSmsTemplates httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewSmsTemplates responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewSmsTemplates responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewSmsTemplates data(@javax.annotation.Nullable ViewSmsTemplatesData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewSmsTemplatesData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewSmsTemplatesData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSmsTemplates viewSmsTemplates = (ViewSmsTemplates) o;
    return Objects.equals(this.httpCode, viewSmsTemplates.httpCode) &&
        Objects.equals(this.responseCode, viewSmsTemplates.responseCode) &&
        Objects.equals(this.responseMsg, viewSmsTemplates.responseMsg) &&
        Objects.equals(this.data, viewSmsTemplates.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSmsTemplates {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSmsTemplates
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSmsTemplates.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSmsTemplates is not found in the empty JSON string", ViewSmsTemplates.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSmsTemplates.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSmsTemplates` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewSmsTemplatesData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSmsTemplates.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSmsTemplates' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSmsTemplates> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSmsTemplates.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSmsTemplates>() {
           @Override
           public void write(JsonWriter out, ViewSmsTemplates value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSmsTemplates read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSmsTemplates given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSmsTemplates
   * @throws IOException if the JSON string is invalid with respect to ViewSmsTemplates
   */
  public static ViewSmsTemplates fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSmsTemplates.class);
  }

  /**
   * Convert an instance of ViewSmsTemplates to an JSON string
   *
   * @return JSON string
   */
