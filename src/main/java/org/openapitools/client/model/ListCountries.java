...
import org.openapitools.client.model.ListCountriesDataInner;
...
public class ListCountries {
  ...
  @javax.annotation.Nullable
  private List<ListCountriesDataInner> data = new ArrayList<>();

  public ListCountries() {
  }

  public ListCountries httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ListCountries responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ListCountries responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ListCountries data(@javax.annotation.Nullable List<ListCountriesDataInner> data) {
    this.data = data;
    return this;
  }

  public ListCountries addDataItem(ListCountriesDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ListCountriesDataInner> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ListCountriesDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListCountries listCountries = (ListCountries) o;
    return Objects.equals(this.httpCode, listCountries.httpCode) &&
        Objects.equals(this.responseCode, listCountries.responseCode) &&
        Objects.equals(this.responseMsg, listCountries.responseMsg) &&
        Objects.equals(this.data, listCountries.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ListCountries
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ListCountries.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ListCountries is not found in the empty JSON string", ListCountries.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ListCountries.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ListCountries` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ListCountriesDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListCountries.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListCountries' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListCountries> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListCountries.class));

       return (TypeAdapter<T>) new TypeAdapter<ListCountries>() {
           @Override
           public void write(JsonWriter out, ListCountries value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ListCountries read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ListCountries given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ListCountries
   * @throws IOException if the JSON string is invalid with respect to ListCountries
   */
  public static ListCountries fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListCountries.class);
  }

  /**
   * Convert an instance of ListCountries to an JSON string
   *
   * @return JSON string
   */
