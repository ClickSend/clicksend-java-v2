...
import org.openapitools.client.model.SendEmailCampaignData;
...
public class SendEmailCampaign {
  ...
  @javax.annotation.Nullable
  private SendEmailCampaignData data;

  public SendEmailCampaign() {
  }

  public SendEmailCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendEmailCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendEmailCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendEmailCampaign data(@javax.annotation.Nullable SendEmailCampaignData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SendEmailCampaignData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable SendEmailCampaignData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendEmailCampaign sendEmailCampaign = (SendEmailCampaign) o;
    return Objects.equals(this.httpCode, sendEmailCampaign.httpCode) &&
        Objects.equals(this.responseCode, sendEmailCampaign.responseCode) &&
        Objects.equals(this.responseMsg, sendEmailCampaign.responseMsg) &&
        Objects.equals(this.data, sendEmailCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendEmailCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendEmailCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendEmailCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendEmailCampaign is not found in the empty JSON string", SendEmailCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendEmailCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendEmailCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        SendEmailCampaignData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendEmailCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendEmailCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendEmailCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendEmailCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<SendEmailCampaign>() {
           @Override
           public void write(JsonWriter out, SendEmailCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendEmailCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendEmailCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendEmailCampaign
   * @throws IOException if the JSON string is invalid with respect to SendEmailCampaign
   */
  public static SendEmailCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendEmailCampaign.class);
  }

  /**
   * Convert an instance of SendEmailCampaign to an JSON string
   *
   * @return JSON string
   */
