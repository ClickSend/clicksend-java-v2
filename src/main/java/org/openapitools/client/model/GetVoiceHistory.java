...
import org.openapitools.client.model.GetVoiceHistoryData;
...
public class GetVoiceHistory {
  ...
  @javax.annotation.Nullable
  private GetVoiceHistoryData data;

  public GetVoiceHistory() {
  }

  public GetVoiceHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public GetVoiceHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public GetVoiceHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public GetVoiceHistory data(@javax.annotation.Nullable GetVoiceHistoryData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public GetVoiceHistoryData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable GetVoiceHistoryData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetVoiceHistory getVoiceHistory = (GetVoiceHistory) o;
    return Objects.equals(this.httpCode, getVoiceHistory.httpCode) &&
        Objects.equals(this.responseCode, getVoiceHistory.responseCode) &&
        Objects.equals(this.responseMsg, getVoiceHistory.responseMsg) &&
        Objects.equals(this.data, getVoiceHistory.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetVoiceHistory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetVoiceHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetVoiceHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetVoiceHistory is not found in the empty JSON string", GetVoiceHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetVoiceHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetVoiceHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        GetVoiceHistoryData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetVoiceHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetVoiceHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetVoiceHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetVoiceHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<GetVoiceHistory>() {
           @Override
           public void write(JsonWriter out, GetVoiceHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetVoiceHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetVoiceHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetVoiceHistory
   * @throws IOException if the JSON string is invalid with respect to GetVoiceHistory
   */
  public static GetVoiceHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetVoiceHistory.class);
  }

  /**
   * Convert an instance of GetVoiceHistory to an JSON string
   *
   * @return JSON string
   */
