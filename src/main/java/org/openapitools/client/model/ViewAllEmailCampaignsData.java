...
public class ViewAllEmailCampaignsData {
  ...
  @javax.annotation.Nullable
  private List<EmailCampaign> data = new ArrayList<>();

  public ViewAllEmailCampaignsData() {
  }

  public ViewAllEmailCampaignsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewAllEmailCampaignsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewAllEmailCampaignsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewAllEmailCampaignsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewAllEmailCampaignsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewAllEmailCampaignsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewAllEmailCampaignsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewAllEmailCampaignsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewAllEmailCampaignsData data(@javax.annotation.Nullable List<EmailCampaign> data) {
    this.data = data;
    return this;
  }

  public ViewAllEmailCampaignsData addDataItem(EmailCampaign dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<EmailCampaign> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<EmailCampaign> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewAllEmailCampaignsData viewAllEmailCampaignsData = (ViewAllEmailCampaignsData) o;
    return Objects.equals(this.total, viewAllEmailCampaignsData.total) &&
        Objects.equals(this.perPage, viewAllEmailCampaignsData.perPage) &&
        Objects.equals(this.currentPage, viewAllEmailCampaignsData.currentPage) &&
        Objects.equals(this.lastPage, viewAllEmailCampaignsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewAllEmailCampaignsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewAllEmailCampaignsData.prevPageUrl) &&
        Objects.equals(this.from, viewAllEmailCampaignsData.from) &&
        Objects.equals(this.to, viewAllEmailCampaignsData.to) &&
        Objects.equals(this.data, viewAllEmailCampaignsData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewAllEmailCampaignsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAllEmailCampaignsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAllEmailCampaignsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAllEmailCampaignsData is not found in the empty JSON string", ViewAllEmailCampaignsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAllEmailCampaignsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAllEmailCampaignsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            EmailCampaign.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAllEmailCampaignsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAllEmailCampaignsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAllEmailCampaignsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAllEmailCampaignsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAllEmailCampaignsData>() {
           @Override
           public void write(JsonWriter out, ViewAllEmailCampaignsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAllEmailCampaignsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAllEmailCampaignsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAllEmailCampaignsData
   * @throws IOException if the JSON string is invalid with respect to ViewAllEmailCampaignsData
   */
  public static ViewAllEmailCampaignsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAllEmailCampaignsData.class);
  }

  /**
   * Convert an instance of ViewAllEmailCampaignsData to an JSON string
   *
   * @return JSON string
   */
