...
import org.openapitools.client.model.CalculateSmsPriceData;
...
public class CalculateSmsPrice {
  ...
  @javax.annotation.Nullable
  private CalculateSmsPriceData data;

  public CalculateSmsPrice() {
  }

  public CalculateSmsPrice httpCode(@javax.annotation.Nullable String httpCode) {
  ...
  public CalculateSmsPrice responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CalculateSmsPrice responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CalculateSmsPrice data(@javax.annotation.Nullable CalculateSmsPriceData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public CalculateSmsPriceData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable CalculateSmsPriceData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CalculateSmsPrice calculateSmsPrice = (CalculateSmsPrice) o;
    return Objects.equals(this.httpCode, calculateSmsPrice.httpCode) &&
        Objects.equals(this.responseCode, calculateSmsPrice.responseCode) &&
        Objects.equals(this.responseMsg, calculateSmsPrice.responseMsg) &&
        Objects.equals(this.data, calculateSmsPrice.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CalculateSmsPrice {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateSmsPrice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateSmsPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CalculateSmsPrice is not found in the empty JSON string", CalculateSmsPrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateSmsPrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CalculateSmsPrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        CalculateSmsPriceData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CalculateSmsPrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CalculateSmsPrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CalculateSmsPrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CalculateSmsPrice.class));

       return (TypeAdapter<T>) new TypeAdapter<CalculateSmsPrice>() {
           @Override
           public void write(JsonWriter out, CalculateSmsPrice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CalculateSmsPrice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CalculateSmsPrice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CalculateSmsPrice
   * @throws IOException if the JSON string is invalid with respect to CalculateSmsPrice
   */
  public static CalculateSmsPrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CalculateSmsPrice.class);
  }

  /**
   * Convert an instance of CalculateSmsPrice to an JSON string
   *
   * @return JSON string
   */
