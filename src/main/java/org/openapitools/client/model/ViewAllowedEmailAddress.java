...
public class ViewAllowedEmailAddress {
  ...
  public ViewAllowedEmailAddress() {
  }

  public ViewAllowedEmailAddress httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewAllowedEmailAddress responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewAllowedEmailAddress responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewAllowedEmailAddress data(@javax.annotation.Nullable EmailAddress data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewAllowedEmailAddress viewAllowedEmailAddress = (ViewAllowedEmailAddress) o;
    return Objects.equals(this.httpCode, viewAllowedEmailAddress.httpCode) &&
        Objects.equals(this.responseCode, viewAllowedEmailAddress.responseCode) &&
        Objects.equals(this.responseMsg, viewAllowedEmailAddress.responseMsg) &&
        Objects.equals(this.data, viewAllowedEmailAddress.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewAllowedEmailAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAllowedEmailAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAllowedEmailAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAllowedEmailAddress is not found in the empty JSON string", ViewAllowedEmailAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAllowedEmailAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAllowedEmailAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAllowedEmailAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAllowedEmailAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAllowedEmailAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAllowedEmailAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAllowedEmailAddress>() {
           @Override
           public void write(JsonWriter out, ViewAllowedEmailAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAllowedEmailAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAllowedEmailAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAllowedEmailAddress
   * @throws IOException if the JSON string is invalid with respect to ViewAllowedEmailAddress
   */
  public static ViewAllowedEmailAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAllowedEmailAddress.class);
  }

  /**
   * Convert an instance of ViewAllowedEmailAddress to an JSON string
   *
   * @return JSON string
   */
