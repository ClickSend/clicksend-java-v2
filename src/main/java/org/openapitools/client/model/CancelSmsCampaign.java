...
public class CancelSmsCampaign {
  ...
  public CancelSmsCampaign() {
  }

  public CancelSmsCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CancelSmsCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CancelSmsCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CancelSmsCampaign data(@javax.annotation.Nullable SmsCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelSmsCampaign cancelSmsCampaign = (CancelSmsCampaign) o;
    return Objects.equals(this.httpCode, cancelSmsCampaign.httpCode) &&
        Objects.equals(this.responseCode, cancelSmsCampaign.responseCode) &&
        Objects.equals(this.responseMsg, cancelSmsCampaign.responseMsg) &&
        Objects.equals(this.data, cancelSmsCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelSmsCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelSmsCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelSmsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelSmsCampaign is not found in the empty JSON string", CancelSmsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelSmsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelSmsCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelSmsCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelSmsCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelSmsCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelSmsCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelSmsCampaign>() {
           @Override
           public void write(JsonWriter out, CancelSmsCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelSmsCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelSmsCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelSmsCampaign
   * @throws IOException if the JSON string is invalid with respect to CancelSmsCampaign
   */
  public static CancelSmsCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelSmsCampaign.class);
  }

  /**
   * Convert an instance of CancelSmsCampaign to an JSON string
   *
   * @return JSON string
   */
