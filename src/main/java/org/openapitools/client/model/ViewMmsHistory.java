...
import org.openapitools.client.model.ViewMmsHistoryData;
...
public class ViewMmsHistory {
  ...
  @javax.annotation.Nullable
  private ViewMmsHistoryData data;

  public ViewMmsHistory() {
  }

  public ViewMmsHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewMmsHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewMmsHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewMmsHistory data(@javax.annotation.Nullable ViewMmsHistoryData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewMmsHistoryData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewMmsHistoryData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewMmsHistory viewMmsHistory = (ViewMmsHistory) o;
    return Objects.equals(this.httpCode, viewMmsHistory.httpCode) &&
        Objects.equals(this.responseCode, viewMmsHistory.responseCode) &&
        Objects.equals(this.responseMsg, viewMmsHistory.responseMsg) &&
        Objects.equals(this.data, viewMmsHistory.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewMmsHistory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewMmsHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewMmsHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewMmsHistory is not found in the empty JSON string", ViewMmsHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewMmsHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewMmsHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewMmsHistoryData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewMmsHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewMmsHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewMmsHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewMmsHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewMmsHistory>() {
           @Override
           public void write(JsonWriter out, ViewMmsHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewMmsHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewMmsHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewMmsHistory
   * @throws IOException if the JSON string is invalid with respect to ViewMmsHistory
   */
  public static ViewMmsHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewMmsHistory.class);
  }

  /**
   * Convert an instance of ViewMmsHistory to an JSON string
   *
   * @return JSON string
   */
