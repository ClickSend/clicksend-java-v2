...
import org.openapitools.client.model.FaxReceipt;
...
public class ViewFaxReceiptsData {
  ...
  @javax.annotation.Nullable
  private List<FaxReceipt> data = new ArrayList<>();

  public ViewFaxReceiptsData() {
  }

  public ViewFaxReceiptsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewFaxReceiptsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewFaxReceiptsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewFaxReceiptsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewFaxReceiptsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewFaxReceiptsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewFaxReceiptsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewFaxReceiptsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewFaxReceiptsData data(@javax.annotation.Nullable List<FaxReceipt> data) {
    this.data = data;
    return this;
  }

  public ViewFaxReceiptsData addDataItem(FaxReceipt dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<FaxReceipt> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<FaxReceipt> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewFaxReceiptsData viewFaxReceiptsData = (ViewFaxReceiptsData) o;
    return Objects.equals(this.total, viewFaxReceiptsData.total) &&
        Objects.equals(this.perPage, viewFaxReceiptsData.perPage) &&
        Objects.equals(this.currentPage, viewFaxReceiptsData.currentPage) &&
        Objects.equals(this.lastPage, viewFaxReceiptsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewFaxReceiptsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewFaxReceiptsData.prevPageUrl) &&
        Objects.equals(this.from, viewFaxReceiptsData.from) &&
        Objects.equals(this.to, viewFaxReceiptsData.to) &&
        Objects.equals(this.data, viewFaxReceiptsData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewFaxReceiptsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewFaxReceiptsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewFaxReceiptsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewFaxReceiptsData is not found in the empty JSON string", ViewFaxReceiptsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewFaxReceiptsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewFaxReceiptsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            FaxReceipt.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewFaxReceiptsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewFaxReceiptsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewFaxReceiptsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewFaxReceiptsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewFaxReceiptsData>() {
           @Override
           public void write(JsonWriter out, ViewFaxReceiptsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewFaxReceiptsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewFaxReceiptsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewFaxReceiptsData
   * @throws IOException if the JSON string is invalid with respect to ViewFaxReceiptsData
   */
  public static ViewFaxReceiptsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewFaxReceiptsData.class);
  }

  /**
   * Convert an instance of ViewFaxReceiptsData to an JSON string
   *
   * @return JSON string
   */
