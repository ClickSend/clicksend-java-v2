...
import org.openapitools.client.model.ViewSmsHistoryDataAllOfDataInner;
...
public class ViewSmsHistoryData {
  ...
  @javax.annotation.Nullable
  private List<ViewSmsHistoryDataAllOfDataInner> data = new ArrayList<>();

  public ViewSmsHistoryData() {
  }

  public ViewSmsHistoryData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewSmsHistoryData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewSmsHistoryData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewSmsHistoryData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewSmsHistoryData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewSmsHistoryData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewSmsHistoryData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewSmsHistoryData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewSmsHistoryData data(@javax.annotation.Nullable List<ViewSmsHistoryDataAllOfDataInner> data) {
    this.data = data;
    return this;
  }

  public ViewSmsHistoryData addDataItem(ViewSmsHistoryDataAllOfDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ViewSmsHistoryDataAllOfDataInner> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ViewSmsHistoryDataAllOfDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSmsHistoryData viewSmsHistoryData = (ViewSmsHistoryData) o;
    return Objects.equals(this.total, viewSmsHistoryData.total) &&
        Objects.equals(this.perPage, viewSmsHistoryData.perPage) &&
        Objects.equals(this.currentPage, viewSmsHistoryData.currentPage) &&
        Objects.equals(this.lastPage, viewSmsHistoryData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewSmsHistoryData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewSmsHistoryData.prevPageUrl) &&
        Objects.equals(this.from, viewSmsHistoryData.from) &&
        Objects.equals(this.to, viewSmsHistoryData.to) &&
        Objects.equals(this.data, viewSmsHistoryData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSmsHistoryData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSmsHistoryData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSmsHistoryData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSmsHistoryData is not found in the empty JSON string", ViewSmsHistoryData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSmsHistoryData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSmsHistoryData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ViewSmsHistoryDataAllOfDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSmsHistoryData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSmsHistoryData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSmsHistoryData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSmsHistoryData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSmsHistoryData>() {
           @Override
           public void write(JsonWriter out, ViewSmsHistoryData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSmsHistoryData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSmsHistoryData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSmsHistoryData
   * @throws IOException if the JSON string is invalid with respect to ViewSmsHistoryData
   */
  public static ViewSmsHistoryData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSmsHistoryData.class);
  }

  /**
   * Convert an instance of ViewSmsHistoryData to an JSON string
   *
   * @return JSON string
   */
