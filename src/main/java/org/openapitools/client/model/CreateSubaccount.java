...
public class CreateSubaccount {
  ...
  public CreateSubaccount httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CreateSubaccount responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CreateSubaccount responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CreateSubaccount data(@javax.annotation.Nullable Subaccount data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, createSubaccount.httpCode) &&
        Objects.equals(this.responseCode, createSubaccount.responseCode) &&
        Objects.equals(this.responseMsg, createSubaccount.responseMsg) &&
        Objects.equals(this.data, createSubaccount.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateSubaccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateSubaccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateSubaccount is not found in the empty JSON string", CreateSubaccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateSubaccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateSubaccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateSubaccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateSubaccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateSubaccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateSubaccount.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateSubaccount>() {
           @Override
           public void write(JsonWriter out, CreateSubaccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateSubaccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateSubaccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateSubaccount
   * @throws IOException if the JSON string is invalid with respect to CreateSubaccount
   */
  public static CreateSubaccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateSubaccount.class);
  }

  /**
   * Convert an instance of CreateSubaccount to an JSON string
   *
   * @return JSON string
   */
