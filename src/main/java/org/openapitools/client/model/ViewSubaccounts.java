...
public class ViewSubaccounts {
  ...
  public ViewSubaccounts httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewSubaccounts responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewSubaccounts responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public boolean equals(Object o) {
    ...
    ViewSubaccounts viewSubaccounts = (ViewSubaccounts) o;
    return Objects.equals(this.httpCode, viewSubaccounts.httpCode) &&
        Objects.equals(this.responseCode, viewSubaccounts.responseCode) &&
        Objects.equals(this.responseMsg, viewSubaccounts.responseMsg) &&
        Objects.equals(this.data, viewSubaccounts.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSubaccounts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSubaccounts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSubaccounts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSubaccounts is not found in the empty JSON string", ViewSubaccounts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSubaccounts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSubaccounts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSubaccounts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSubaccounts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSubaccounts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSubaccounts.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSubaccounts>() {
           @Override
           public void write(JsonWriter out, ViewSubaccounts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSubaccounts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSubaccounts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSubaccounts
   * @throws IOException if the JSON string is invalid with respect to ViewSubaccounts
   */
  public static ViewSubaccounts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSubaccounts.class);
  }

  /**
   * Convert an instance of ViewSubaccounts to an JSON string
   *
   * @return JSON string
   */
