...
import org.openapitools.client.model.UpdatePaymentInfoData;
...
public class UpdatePaymentInfo {
  ...
  public UpdatePaymentInfo httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdatePaymentInfo responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdatePaymentInfo responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdatePaymentInfo data(@javax.annotation.Nullable UpdatePaymentInfoData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable UpdatePaymentInfoData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, updatePaymentInfo.httpCode) &&
        Objects.equals(this.responseCode, updatePaymentInfo.responseCode) &&
        Objects.equals(this.responseMsg, updatePaymentInfo.responseMsg) &&
        Objects.equals(this.data, updatePaymentInfo.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdatePaymentInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdatePaymentInfo is not found in the empty JSON string", UpdatePaymentInfo.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdatePaymentInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdatePaymentInfo` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        UpdatePaymentInfoData.validateJsonElement(jsonObj.get("data"));
      }
  }
