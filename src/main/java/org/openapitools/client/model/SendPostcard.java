...
public class SendPostcard {
  ...
  public SendPostcard httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendPostcard responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendPostcard responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendPostcard data(@javax.annotation.Nullable SendPostcardData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendPostcard sendPostcard = (SendPostcard) o;
    return Objects.equals(this.httpCode, sendPostcard.httpCode) &&
        Objects.equals(this.responseCode, sendPostcard.responseCode) &&
        Objects.equals(this.responseMsg, sendPostcard.responseMsg) &&
        Objects.equals(this.data, sendPostcard.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendPostcard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendPostcard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendPostcard is not found in the empty JSON string", SendPostcard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendPostcard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendPostcard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendPostcard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendPostcard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendPostcard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendPostcard.class));

       return (TypeAdapter<T>) new TypeAdapter<SendPostcard>() {
           @Override
           public void write(JsonWriter out, SendPostcard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendPostcard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendPostcard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendPostcard
   * @throws IOException if the JSON string is invalid with respect to SendPostcard
   */
  public static SendPostcard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendPostcard.class);
  }

  /**
   * Convert an instance of SendPostcard to an JSON string
   *
   * @return JSON string
   */
