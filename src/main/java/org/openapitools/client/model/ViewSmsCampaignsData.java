...
public class ViewSmsCampaignsData {
  ...
  @javax.annotation.Nullable
  private List<SmsCampaign> data = new ArrayList<>();

  public ViewSmsCampaignsData() {
  }

  public ViewSmsCampaignsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewSmsCampaignsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewSmsCampaignsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewSmsCampaignsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewSmsCampaignsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewSmsCampaignsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewSmsCampaignsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewSmsCampaignsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewSmsCampaignsData data(@javax.annotation.Nullable List<SmsCampaign> data) {
    this.data = data;
    return this;
  }

  public ViewSmsCampaignsData addDataItem(SmsCampaign dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<SmsCampaign> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<SmsCampaign> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSmsCampaignsData viewSmsCampaignsData = (ViewSmsCampaignsData) o;
    return Objects.equals(this.total, viewSmsCampaignsData.total) &&
        Objects.equals(this.perPage, viewSmsCampaignsData.perPage) &&
        Objects.equals(this.currentPage, viewSmsCampaignsData.currentPage) &&
        Objects.equals(this.lastPage, viewSmsCampaignsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewSmsCampaignsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewSmsCampaignsData.prevPageUrl) &&
        Objects.equals(this.from, viewSmsCampaignsData.from) &&
        Objects.equals(this.to, viewSmsCampaignsData.to) &&
        Objects.equals(this.data, viewSmsCampaignsData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSmsCampaignsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSmsCampaignsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSmsCampaignsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSmsCampaignsData is not found in the empty JSON string", ViewSmsCampaignsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSmsCampaignsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSmsCampaignsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            SmsCampaign.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSmsCampaignsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSmsCampaignsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSmsCampaignsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSmsCampaignsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSmsCampaignsData>() {
           @Override
           public void write(JsonWriter out, ViewSmsCampaignsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSmsCampaignsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSmsCampaignsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSmsCampaignsData
   * @throws IOException if the JSON string is invalid with respect to ViewSmsCampaignsData
   */
  public static ViewSmsCampaignsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSmsCampaignsData.class);
  }

  /**
   * Convert an instance of ViewSmsCampaignsData to an JSON string
   *
   * @return JSON string
   */
