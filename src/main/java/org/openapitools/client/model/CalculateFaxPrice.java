...
import org.openapitools.client.model.SendFaxData;
...
public class CalculateFaxPrice {
  ...
  @javax.annotation.Nullable
  private SendFaxData data;

  public CalculateFaxPrice() {
  }

  public CalculateFaxPrice httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CalculateFaxPrice responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CalculateFaxPrice responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CalculateFaxPrice data(@javax.annotation.Nullable SendFaxData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SendFaxData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable SendFaxData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CalculateFaxPrice calculateFaxPrice = (CalculateFaxPrice) o;
    return Objects.equals(this.httpCode, calculateFaxPrice.httpCode) &&
        Objects.equals(this.responseCode, calculateFaxPrice.responseCode) &&
        Objects.equals(this.responseMsg, calculateFaxPrice.responseMsg) &&
        Objects.equals(this.data, calculateFaxPrice.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CalculateFaxPrice
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CalculateFaxPrice.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CalculateFaxPrice is not found in the empty JSON string", CalculateFaxPrice.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CalculateFaxPrice.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CalculateFaxPrice` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        SendFaxData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CalculateFaxPrice.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CalculateFaxPrice' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CalculateFaxPrice> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CalculateFaxPrice.class));

       return (TypeAdapter<T>) new TypeAdapter<CalculateFaxPrice>() {
           @Override
           public void write(JsonWriter out, CalculateFaxPrice value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CalculateFaxPrice read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CalculateFaxPrice given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CalculateFaxPrice
   * @throws IOException if the JSON string is invalid with respect to CalculateFaxPrice
   */
  public static CalculateFaxPrice fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CalculateFaxPrice.class);
  }

  /**
   * Convert an instance of CalculateFaxPrice to an JSON string
   *
   * @return JSON string
   */
