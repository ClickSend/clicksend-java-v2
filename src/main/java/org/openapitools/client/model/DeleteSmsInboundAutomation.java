...
public class DeleteSmsInboundAutomation {
  ...
  public DeleteSmsInboundAutomation() {
  }

  public DeleteSmsInboundAutomation httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteSmsInboundAutomation responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteSmsInboundAutomation responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteSmsInboundAutomation data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteSmsInboundAutomation addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteSmsInboundAutomation deleteSmsInboundAutomation = (DeleteSmsInboundAutomation) o;
    return Objects.equals(this.httpCode, deleteSmsInboundAutomation.httpCode) &&
        Objects.equals(this.responseCode, deleteSmsInboundAutomation.responseCode) &&
        Objects.equals(this.responseMsg, deleteSmsInboundAutomation.responseMsg) &&
        Objects.equals(this.data, deleteSmsInboundAutomation.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteSmsInboundAutomation {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteSmsInboundAutomation
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteSmsInboundAutomation.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteSmsInboundAutomation is not found in the empty JSON string", DeleteSmsInboundAutomation.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteSmsInboundAutomation.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteSmsInboundAutomation` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteSmsInboundAutomation.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteSmsInboundAutomation' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteSmsInboundAutomation> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteSmsInboundAutomation.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteSmsInboundAutomation>() {
           @Override
           public void write(JsonWriter out, DeleteSmsInboundAutomation value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteSmsInboundAutomation read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteSmsInboundAutomation given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteSmsInboundAutomation
   * @throws IOException if the JSON string is invalid with respect to DeleteSmsInboundAutomation
   */
  public static DeleteSmsInboundAutomation fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteSmsInboundAutomation.class);
  }

  /**
   * Convert an instance of DeleteSmsInboundAutomation to an JSON string
   *
   * @return JSON string
   */
