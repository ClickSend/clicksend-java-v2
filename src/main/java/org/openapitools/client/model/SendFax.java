...
public class SendFax {
  ...
  public SendFax httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendFax responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendFax responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendFax data(@javax.annotation.Nullable SendFaxData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendFax sendFax = (SendFax) o;
    return Objects.equals(this.httpCode, sendFax.httpCode) &&
        Objects.equals(this.responseCode, sendFax.responseCode) &&
        Objects.equals(this.responseMsg, sendFax.responseMsg) &&
        Objects.equals(this.data, sendFax.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendFax
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendFax.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendFax is not found in the empty JSON string", SendFax.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendFax.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendFax` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendFax.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendFax' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendFax> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendFax.class));

       return (TypeAdapter<T>) new TypeAdapter<SendFax>() {
           @Override
           public void write(JsonWriter out, SendFax value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendFax read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendFax given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendFax
   * @throws IOException if the JSON string is invalid with respect to SendFax
   */
  public static SendFax fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendFax.class);
  }

  /**
   * Convert an instance of SendFax to an JSON string
   *
   * @return JSON string
   */
