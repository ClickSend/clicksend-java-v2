...
public class ViewEmailHistory {
  ...
  public ViewEmailHistory() {
  }

  public ViewEmailHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewEmailHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewEmailHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewEmailHistory data(@javax.annotation.Nullable CalculateEmailPriceData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewEmailHistory viewEmailHistory = (ViewEmailHistory) o;
    return Objects.equals(this.httpCode, viewEmailHistory.httpCode) &&
        Objects.equals(this.responseCode, viewEmailHistory.responseCode) &&
        Objects.equals(this.responseMsg, viewEmailHistory.responseMsg) &&
        Objects.equals(this.data, viewEmailHistory.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewEmailHistory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewEmailHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewEmailHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewEmailHistory is not found in the empty JSON string", ViewEmailHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewEmailHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewEmailHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewEmailHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewEmailHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewEmailHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewEmailHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewEmailHistory>() {
           @Override
           public void write(JsonWriter out, ViewEmailHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewEmailHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewEmailHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewEmailHistory
   * @throws IOException if the JSON string is invalid with respect to ViewEmailHistory
   */
  public static ViewEmailHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewEmailHistory.class);
  }

  /**
   * Convert an instance of ViewEmailHistory to an JSON string
   *
   * @return JSON string
   */
