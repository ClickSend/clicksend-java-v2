...
import org.openapitools.client.model.ViewMmsHistoryDataAllOfDataInner;
...
public class ViewMmsHistoryData {
  ...
  @javax.annotation.Nullable
  private List<ViewMmsHistoryDataAllOfDataInner> data = new ArrayList<>();

  public ViewMmsHistoryData() {
  }

  public ViewMmsHistoryData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewMmsHistoryData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewMmsHistoryData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewMmsHistoryData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewMmsHistoryData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewMmsHistoryData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewMmsHistoryData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewMmsHistoryData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewMmsHistoryData data(@javax.annotation.Nullable List<ViewMmsHistoryDataAllOfDataInner> data) {
    this.data = data;
    return this;
  }

  public ViewMmsHistoryData addDataItem(ViewMmsHistoryDataAllOfDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ViewMmsHistoryDataAllOfDataInner> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ViewMmsHistoryDataAllOfDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewMmsHistoryData viewMmsHistoryData = (ViewMmsHistoryData) o;
    return Objects.equals(this.total, viewMmsHistoryData.total) &&
        Objects.equals(this.perPage, viewMmsHistoryData.perPage) &&
        Objects.equals(this.currentPage, viewMmsHistoryData.currentPage) &&
        Objects.equals(this.lastPage, viewMmsHistoryData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewMmsHistoryData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewMmsHistoryData.prevPageUrl) &&
        Objects.equals(this.from, viewMmsHistoryData.from) &&
        Objects.equals(this.to, viewMmsHistoryData.to) &&
        Objects.equals(this.data, viewMmsHistoryData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewMmsHistoryData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewMmsHistoryData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewMmsHistoryData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewMmsHistoryData is not found in the empty JSON string", ViewMmsHistoryData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewMmsHistoryData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewMmsHistoryData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ViewMmsHistoryDataAllOfDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewMmsHistoryData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewMmsHistoryData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewMmsHistoryData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewMmsHistoryData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewMmsHistoryData>() {
           @Override
           public void write(JsonWriter out, ViewMmsHistoryData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewMmsHistoryData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewMmsHistoryData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewMmsHistoryData
   * @throws IOException if the JSON string is invalid with respect to ViewMmsHistoryData
   */
  public static ViewMmsHistoryData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewMmsHistoryData.class);
  }

  /**
   * Convert an instance of ViewMmsHistoryData to an JSON string
   *
   * @return JSON string
   */
