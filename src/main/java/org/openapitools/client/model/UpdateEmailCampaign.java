...
public class UpdateEmailCampaign {
  ...
  public UpdateEmailCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdateEmailCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateEmailCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateEmailCampaign data(@javax.annotation.Nullable EmailCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, updateEmailCampaign.httpCode) &&
        Objects.equals(this.responseCode, updateEmailCampaign.responseCode) &&
        Objects.equals(this.responseMsg, updateEmailCampaign.responseMsg) &&
        Objects.equals(this.data, updateEmailCampaign.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateEmailCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEmailCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateEmailCampaign is not found in the empty JSON string", UpdateEmailCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEmailCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateEmailCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateEmailCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateEmailCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateEmailCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateEmailCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateEmailCampaign>() {
           @Override
           public void write(JsonWriter out, UpdateEmailCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateEmailCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateEmailCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateEmailCampaign
   * @throws IOException if the JSON string is invalid with respect to UpdateEmailCampaign
   */
  public static UpdateEmailCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateEmailCampaign.class);
  }

  /**
   * Convert an instance of UpdateEmailCampaign to an JSON string
   *
   * @return JSON string
   */
