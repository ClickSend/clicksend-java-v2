...
import org.openapitools.client.model.ViewAllowedEmailsDataInner;
...
public class ViewAllowedEmails {
  ...
  @javax.annotation.Nullable
  private List<ViewAllowedEmailsDataInner> data = new ArrayList<>();

  public ViewAllowedEmails() {
  }

  public ViewAllowedEmails httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewAllowedEmails responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewAllowedEmails responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewAllowedEmails data(@javax.annotation.Nullable List<ViewAllowedEmailsDataInner> data) {
    this.data = data;
    return this;
  }

  public ViewAllowedEmails addDataItem(ViewAllowedEmailsDataInner dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<ViewAllowedEmailsDataInner> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<ViewAllowedEmailsDataInner> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewAllowedEmails viewAllowedEmails = (ViewAllowedEmails) o;
    return Objects.equals(this.httpCode, viewAllowedEmails.httpCode) &&
        Objects.equals(this.responseCode, viewAllowedEmails.responseCode) &&
        Objects.equals(this.responseMsg, viewAllowedEmails.responseMsg) &&
        Objects.equals(this.data, viewAllowedEmails.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewAllowedEmails {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAllowedEmails
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAllowedEmails.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAllowedEmails is not found in the empty JSON string", ViewAllowedEmails.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAllowedEmails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAllowedEmails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            ViewAllowedEmailsDataInner.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAllowedEmails.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAllowedEmails' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAllowedEmails> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAllowedEmails.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAllowedEmails>() {
           @Override
           public void write(JsonWriter out, ViewAllowedEmails value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAllowedEmails read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAllowedEmails given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAllowedEmails
   * @throws IOException if the JSON string is invalid with respect to ViewAllowedEmails
   */
  public static ViewAllowedEmails fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAllowedEmails.class);
  }

  /**
   * Convert an instance of ViewAllowedEmails to an JSON string
   *
   * @return JSON string
   */
