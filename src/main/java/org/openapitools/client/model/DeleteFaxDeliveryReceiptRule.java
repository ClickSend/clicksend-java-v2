...
public class DeleteFaxDeliveryReceiptRule {
  ...
  public DeleteFaxDeliveryReceiptRule() {
  }

  public DeleteFaxDeliveryReceiptRule httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteFaxDeliveryReceiptRule responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteFaxDeliveryReceiptRule responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteFaxDeliveryReceiptRule data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    DeleteFaxDeliveryReceiptRule deleteFaxDeliveryReceiptRule = (DeleteFaxDeliveryReceiptRule) o;
    return Objects.equals(this.httpCode, deleteFaxDeliveryReceiptRule.httpCode) &&
        Objects.equals(this.responseCode, deleteFaxDeliveryReceiptRule.responseCode) &&
        Objects.equals(this.responseMsg, deleteFaxDeliveryReceiptRule.responseMsg) &&
        Objects.equals(this.data, deleteFaxDeliveryReceiptRule.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteFaxDeliveryReceiptRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteFaxDeliveryReceiptRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteFaxDeliveryReceiptRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteFaxDeliveryReceiptRule is not found in the empty JSON string", DeleteFaxDeliveryReceiptRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteFaxDeliveryReceiptRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteFaxDeliveryReceiptRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteFaxDeliveryReceiptRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteFaxDeliveryReceiptRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteFaxDeliveryReceiptRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteFaxDeliveryReceiptRule.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteFaxDeliveryReceiptRule>() {
           @Override
           public void write(JsonWriter out, DeleteFaxDeliveryReceiptRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteFaxDeliveryReceiptRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteFaxDeliveryReceiptRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteFaxDeliveryReceiptRule
   * @throws IOException if the JSON string is invalid with respect to DeleteFaxDeliveryReceiptRule
   */
  public static DeleteFaxDeliveryReceiptRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteFaxDeliveryReceiptRule.class);
  }

  /**
   * Convert an instance of DeleteFaxDeliveryReceiptRule to an JSON string
   *
   * @return JSON string
   */
