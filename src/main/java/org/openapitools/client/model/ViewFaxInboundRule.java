...
public class ViewFaxInboundRule {
  ...
  public ViewFaxInboundRule() {
  }

  public ViewFaxInboundRule httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewFaxInboundRule responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewFaxInboundRule responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewFaxInboundRule data(@javax.annotation.Nullable InboundFaxRule data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewFaxInboundRule viewFaxInboundRule = (ViewFaxInboundRule) o;
    return Objects.equals(this.httpCode, viewFaxInboundRule.httpCode) &&
        Objects.equals(this.responseCode, viewFaxInboundRule.responseCode) &&
        Objects.equals(this.responseMsg, viewFaxInboundRule.responseMsg) &&
        Objects.equals(this.data, viewFaxInboundRule.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewFaxInboundRule {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewFaxInboundRule
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewFaxInboundRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewFaxInboundRule is not found in the empty JSON string", ViewFaxInboundRule.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewFaxInboundRule.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewFaxInboundRule` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewFaxInboundRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewFaxInboundRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewFaxInboundRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewFaxInboundRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewFaxInboundRule>() {
           @Override
           public void write(JsonWriter out, ViewFaxInboundRule value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewFaxInboundRule read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewFaxInboundRule given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewFaxInboundRule
   * @throws IOException if the JSON string is invalid with respect to ViewFaxInboundRule
   */
  public static ViewFaxInboundRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewFaxInboundRule.class);
  }

  /**
   * Convert an instance of ViewFaxInboundRule to an JSON string
   *
   * @return JSON string
   */
