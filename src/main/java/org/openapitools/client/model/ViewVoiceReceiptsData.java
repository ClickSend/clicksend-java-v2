...
import org.openapitools.client.model.VoiceReceipt;
...
public class ViewVoiceReceiptsData {
  ...
  @javax.annotation.Nullable
  private List<VoiceReceipt> data = new ArrayList<>();

  public ViewVoiceReceiptsData() {
  }

  public ViewVoiceReceiptsData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewVoiceReceiptsData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewVoiceReceiptsData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewVoiceReceiptsData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewVoiceReceiptsData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewVoiceReceiptsData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewVoiceReceiptsData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewVoiceReceiptsData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewVoiceReceiptsData data(@javax.annotation.Nullable List<VoiceReceipt> data) {
    this.data = data;
    return this;
  }

  public ViewVoiceReceiptsData addDataItem(VoiceReceipt dataItem) {
    if (this.data == null) {
   ...
   */
  @javax.annotation.Nullable
  public List<VoiceReceipt> getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable List<VoiceReceipt> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewVoiceReceiptsData viewVoiceReceiptsData = (ViewVoiceReceiptsData) o;
    return Objects.equals(this.total, viewVoiceReceiptsData.total) &&
        Objects.equals(this.perPage, viewVoiceReceiptsData.perPage) &&
        Objects.equals(this.currentPage, viewVoiceReceiptsData.currentPage) &&
        Objects.equals(this.lastPage, viewVoiceReceiptsData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewVoiceReceiptsData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewVoiceReceiptsData.prevPageUrl) &&
        Objects.equals(this.from, viewVoiceReceiptsData.from) &&
        Objects.equals(this.to, viewVoiceReceiptsData.to) &&
        Objects.equals(this.data, viewVoiceReceiptsData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewVoiceReceiptsData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewVoiceReceiptsData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewVoiceReceiptsData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewVoiceReceiptsData is not found in the empty JSON string", ViewVoiceReceiptsData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewVoiceReceiptsData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewVoiceReceiptsData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ...
        if (jsonArraydata != null) {
          ...
          for (int i = 0; i < jsonArraydata.size(); i++) {
            VoiceReceipt.validateJsonElement(jsonArraydata.get(i));
          };
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewVoiceReceiptsData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewVoiceReceiptsData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewVoiceReceiptsData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewVoiceReceiptsData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewVoiceReceiptsData>() {
           @Override
           public void write(JsonWriter out, ViewVoiceReceiptsData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewVoiceReceiptsData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewVoiceReceiptsData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewVoiceReceiptsData
   * @throws IOException if the JSON string is invalid with respect to ViewVoiceReceiptsData
   */
  public static ViewVoiceReceiptsData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewVoiceReceiptsData.class);
  }

  /**
   * Convert an instance of ViewVoiceReceiptsData to an JSON string
   *
   * @return JSON string
   */
