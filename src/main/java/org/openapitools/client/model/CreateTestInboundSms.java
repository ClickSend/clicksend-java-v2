...
import org.openapitools.client.model.InboundSmsTest;
...
public class CreateTestInboundSms {
  ...
  @javax.annotation.Nullable
  private InboundSmsTest data;

  public CreateTestInboundSms() {
  }

  public CreateTestInboundSms httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CreateTestInboundSms responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CreateTestInboundSms responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CreateTestInboundSms data(@javax.annotation.Nullable InboundSmsTest data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public InboundSmsTest getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable InboundSmsTest data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateTestInboundSms createTestInboundSms = (CreateTestInboundSms) o;
    return Objects.equals(this.httpCode, createTestInboundSms.httpCode) &&
        Objects.equals(this.responseCode, createTestInboundSms.responseCode) &&
        Objects.equals(this.responseMsg, createTestInboundSms.responseMsg) &&
        Objects.equals(this.data, createTestInboundSms.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateTestInboundSms {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateTestInboundSms
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateTestInboundSms.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateTestInboundSms is not found in the empty JSON string", CreateTestInboundSms.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateTestInboundSms.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateTestInboundSms` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        InboundSmsTest.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateTestInboundSms.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateTestInboundSms' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateTestInboundSms> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateTestInboundSms.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateTestInboundSms>() {
           @Override
           public void write(JsonWriter out, CreateTestInboundSms value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateTestInboundSms read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateTestInboundSms given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateTestInboundSms
   * @throws IOException if the JSON string is invalid with respect to CreateTestInboundSms
   */
  public static CreateTestInboundSms fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateTestInboundSms.class);
  }

  /**
   * Convert an instance of CreateTestInboundSms to an JSON string
   *
   * @return JSON string
   */
