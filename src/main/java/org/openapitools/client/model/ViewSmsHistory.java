...
import org.openapitools.client.model.ViewSmsHistoryData;
...
public class ViewSmsHistory {
  ...
  @javax.annotation.Nullable
  private ViewSmsHistoryData data;

  public ViewSmsHistory() {
  }

  public ViewSmsHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewSmsHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewSmsHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewSmsHistory data(@javax.annotation.Nullable ViewSmsHistoryData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewSmsHistoryData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewSmsHistoryData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSmsHistory viewSmsHistory = (ViewSmsHistory) o;
    return Objects.equals(this.httpCode, viewSmsHistory.httpCode) &&
        Objects.equals(this.responseCode, viewSmsHistory.responseCode) &&
        Objects.equals(this.responseMsg, viewSmsHistory.responseMsg) &&
        Objects.equals(this.data, viewSmsHistory.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSmsHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSmsHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSmsHistory is not found in the empty JSON string", ViewSmsHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSmsHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSmsHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewSmsHistoryData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSmsHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSmsHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSmsHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSmsHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSmsHistory>() {
           @Override
           public void write(JsonWriter out, ViewSmsHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSmsHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSmsHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSmsHistory
   * @throws IOException if the JSON string is invalid with respect to ViewSmsHistory
   */
  public static ViewSmsHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSmsHistory.class);
  }

  /**
   * Convert an instance of ViewSmsHistory to an JSON string
   *
   * @return JSON string
   */
