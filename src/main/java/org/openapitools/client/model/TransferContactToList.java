...
public class TransferContactToList {
  ...
  public TransferContactToList() {
  }

  public TransferContactToList httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public TransferContactToList responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public TransferContactToList responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public TransferContactToList data(@javax.annotation.Nullable Contact data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable Contact data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    TransferContactToList transferContactToList = (TransferContactToList) o;
    return Objects.equals(this.httpCode, transferContactToList.httpCode) &&
        Objects.equals(this.responseCode, transferContactToList.responseCode) &&
        Objects.equals(this.responseMsg, transferContactToList.responseMsg) &&
        Objects.equals(this.data, transferContactToList.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class TransferContactToList {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to TransferContactToList
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!TransferContactToList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in TransferContactToList is not found in the empty JSON string", TransferContactToList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TransferContactToList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `TransferContactToList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TransferContactToList.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TransferContactToList' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TransferContactToList> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TransferContactToList.class));

       return (TypeAdapter<T>) new TypeAdapter<TransferContactToList>() {
           @Override
           public void write(JsonWriter out, TransferContactToList value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public TransferContactToList read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of TransferContactToList given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of TransferContactToList
   * @throws IOException if the JSON string is invalid with respect to TransferContactToList
   */
  public static TransferContactToList fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TransferContactToList.class);
  }

  /**
   * Convert an instance of TransferContactToList to an JSON string
   *
   * @return JSON string
   */
