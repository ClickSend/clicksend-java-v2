...
public class CancelEmailCampaign {
  ...
  public CancelEmailCampaign() {
  }

  public CancelEmailCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CancelEmailCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CancelEmailCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CancelEmailCampaign data(@javax.annotation.Nullable EmailCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelEmailCampaign cancelEmailCampaign = (CancelEmailCampaign) o;
    return Objects.equals(this.httpCode, cancelEmailCampaign.httpCode) &&
        Objects.equals(this.responseCode, cancelEmailCampaign.responseCode) &&
        Objects.equals(this.responseMsg, cancelEmailCampaign.responseMsg) &&
        Objects.equals(this.data, cancelEmailCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelEmailCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelEmailCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelEmailCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelEmailCampaign is not found in the empty JSON string", CancelEmailCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelEmailCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelEmailCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelEmailCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelEmailCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelEmailCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelEmailCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelEmailCampaign>() {
           @Override
           public void write(JsonWriter out, CancelEmailCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelEmailCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelEmailCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelEmailCampaign
   * @throws IOException if the JSON string is invalid with respect to CancelEmailCampaign
   */
  public static CancelEmailCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelEmailCampaign.class);
  }

  /**
   * Convert an instance of CancelEmailCampaign to an JSON string
   *
   * @return JSON string
   */
