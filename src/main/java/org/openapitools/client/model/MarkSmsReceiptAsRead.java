...
public class MarkSmsReceiptAsRead {
  ...
  public MarkSmsReceiptAsRead() {
  }

  public MarkSmsReceiptAsRead httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public MarkSmsReceiptAsRead responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public MarkSmsReceiptAsRead responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public MarkSmsReceiptAsRead data(@javax.annotation.Nullable Object data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MarkSmsReceiptAsRead markSmsReceiptAsRead = (MarkSmsReceiptAsRead) o;
    return Objects.equals(this.httpCode, markSmsReceiptAsRead.httpCode) &&
        Objects.equals(this.responseCode, markSmsReceiptAsRead.responseCode) &&
        Objects.equals(this.responseMsg, markSmsReceiptAsRead.responseMsg) &&
        Objects.equals(this.data, markSmsReceiptAsRead.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to MarkSmsReceiptAsRead
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MarkSmsReceiptAsRead.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in MarkSmsReceiptAsRead is not found in the empty JSON string", MarkSmsReceiptAsRead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MarkSmsReceiptAsRead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `MarkSmsReceiptAsRead` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MarkSmsReceiptAsRead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MarkSmsReceiptAsRead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MarkSmsReceiptAsRead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MarkSmsReceiptAsRead.class));

       return (TypeAdapter<T>) new TypeAdapter<MarkSmsReceiptAsRead>() {
           @Override
           public void write(JsonWriter out, MarkSmsReceiptAsRead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public MarkSmsReceiptAsRead read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of MarkSmsReceiptAsRead given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MarkSmsReceiptAsRead
   * @throws IOException if the JSON string is invalid with respect to MarkSmsReceiptAsRead
   */
  public static MarkSmsReceiptAsRead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MarkSmsReceiptAsRead.class);
  }

  /**
   * Convert an instance of MarkSmsReceiptAsRead to an JSON string
   *
   * @return JSON string
   */
