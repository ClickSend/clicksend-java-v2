...
public class CancelScheduledPostcard {
  ...
  public CancelScheduledPostcard() {
  }

  public CancelScheduledPostcard httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CancelScheduledPostcard responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CancelScheduledPostcard responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CancelScheduledPostcard data(@javax.annotation.Nullable Boolean data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelScheduledPostcard cancelScheduledPostcard = (CancelScheduledPostcard) o;
    return Objects.equals(this.httpCode, cancelScheduledPostcard.httpCode) &&
        Objects.equals(this.responseCode, cancelScheduledPostcard.responseCode) &&
        Objects.equals(this.responseMsg, cancelScheduledPostcard.responseMsg) &&
        Objects.equals(this.data, cancelScheduledPostcard.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelScheduledPostcard {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelScheduledPostcard
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelScheduledPostcard.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelScheduledPostcard is not found in the empty JSON string", CancelScheduledPostcard.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelScheduledPostcard.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelScheduledPostcard` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelScheduledPostcard.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelScheduledPostcard' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelScheduledPostcard> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelScheduledPostcard.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelScheduledPostcard>() {
           @Override
           public void write(JsonWriter out, CancelScheduledPostcard value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelScheduledPostcard read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelScheduledPostcard given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelScheduledPostcard
   * @throws IOException if the JSON string is invalid with respect to CancelScheduledPostcard
   */
  public static CancelScheduledPostcard fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelScheduledPostcard.class);
  }

  /**
   * Convert an instance of CancelScheduledPostcard to an JSON string
   *
   * @return JSON string
   */
