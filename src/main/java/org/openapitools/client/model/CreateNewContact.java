...
public class CreateNewContact {
  ...
  public CreateNewContact httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CreateNewContact responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CreateNewContact responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CreateNewContact data(@javax.annotation.Nullable Contact data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateNewContact createNewContact = (CreateNewContact) o;
    return Objects.equals(this.httpCode, createNewContact.httpCode) &&
        Objects.equals(this.responseCode, createNewContact.responseCode) &&
        Objects.equals(this.responseMsg, createNewContact.responseMsg) &&
        Objects.equals(this.data, createNewContact.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNewContact {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateNewContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateNewContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateNewContact is not found in the empty JSON string", CreateNewContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateNewContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateNewContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateNewContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateNewContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateNewContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateNewContact.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateNewContact>() {
           @Override
           public void write(JsonWriter out, CreateNewContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateNewContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateNewContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateNewContact
   * @throws IOException if the JSON string is invalid with respect to CreateNewContact
   */
  public static CreateNewContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateNewContact.class);
  }

  /**
   * Convert an instance of CreateNewContact to an JSON string
   *
   * @return JSON string
   */
