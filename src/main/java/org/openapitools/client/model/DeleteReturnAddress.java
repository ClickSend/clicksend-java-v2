...
public class DeleteReturnAddress {
  ...
  public DeleteReturnAddress() {
  }

  public DeleteReturnAddress httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public DeleteReturnAddress responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public DeleteReturnAddress responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public DeleteReturnAddress data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public DeleteReturnAddress addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    DeleteReturnAddress deleteReturnAddress = (DeleteReturnAddress) o;
    return Objects.equals(this.httpCode, deleteReturnAddress.httpCode) &&
        Objects.equals(this.responseCode, deleteReturnAddress.responseCode) &&
        Objects.equals(this.responseMsg, deleteReturnAddress.responseMsg) &&
        Objects.equals(this.data, deleteReturnAddress.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class DeleteReturnAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to DeleteReturnAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!DeleteReturnAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in DeleteReturnAddress is not found in the empty JSON string", DeleteReturnAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DeleteReturnAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `DeleteReturnAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!DeleteReturnAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'DeleteReturnAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<DeleteReturnAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(DeleteReturnAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<DeleteReturnAddress>() {
           @Override
           public void write(JsonWriter out, DeleteReturnAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public DeleteReturnAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of DeleteReturnAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of DeleteReturnAddress
   * @throws IOException if the JSON string is invalid with respect to DeleteReturnAddress
   */
  public static DeleteReturnAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, DeleteReturnAddress.class);
  }

  /**
   * Convert an instance of DeleteReturnAddress to an JSON string
   *
   * @return JSON string
   */
