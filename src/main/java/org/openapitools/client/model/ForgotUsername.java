...
public class ForgotUsername {
  ...
  public ForgotUsername httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ForgotUsername responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ForgotUsername responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ForgotUsername data(@javax.annotation.Nullable List<String> data) {
    this.data = data;
    return this;
  }

  public ForgotUsername addDataItem(String dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, forgotUsername.httpCode) &&
        Objects.equals(this.responseCode, forgotUsername.responseCode) &&
        Objects.equals(this.responseMsg, forgotUsername.responseMsg) &&
        Objects.equals(this.data, forgotUsername.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ForgotUsername
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ForgotUsername.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ForgotUsername is not found in the empty JSON string", ForgotUsername.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ForgotUsername.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ForgotUsername` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ForgotUsername.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ForgotUsername' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ForgotUsername> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ForgotUsername.class));

       return (TypeAdapter<T>) new TypeAdapter<ForgotUsername>() {
           @Override
           public void write(JsonWriter out, ForgotUsername value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ForgotUsername read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ForgotUsername given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ForgotUsername
   * @throws IOException if the JSON string is invalid with respect to ForgotUsername
   */
  public static ForgotUsername fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ForgotUsername.class);
  }

  /**
   * Convert an instance of ForgotUsername to an JSON string
   *
   * @return JSON string
   */
