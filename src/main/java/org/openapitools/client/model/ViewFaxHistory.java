...
import org.openapitools.client.model.ViewFaxHistoryData;
...
public class ViewFaxHistory {
  ...
  @javax.annotation.Nullable
  private ViewFaxHistoryData data;

  public ViewFaxHistory() {
  }

  public ViewFaxHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewFaxHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewFaxHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewFaxHistory data(@javax.annotation.Nullable ViewFaxHistoryData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewFaxHistoryData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewFaxHistoryData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewFaxHistory viewFaxHistory = (ViewFaxHistory) o;
    return Objects.equals(this.httpCode, viewFaxHistory.httpCode) &&
        Objects.equals(this.responseCode, viewFaxHistory.responseCode) &&
        Objects.equals(this.responseMsg, viewFaxHistory.responseMsg) &&
        Objects.equals(this.data, viewFaxHistory.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewFaxHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewFaxHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewFaxHistory is not found in the empty JSON string", ViewFaxHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewFaxHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewFaxHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewFaxHistoryData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewFaxHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewFaxHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewFaxHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewFaxHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewFaxHistory>() {
           @Override
           public void write(JsonWriter out, ViewFaxHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewFaxHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewFaxHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewFaxHistory
   * @throws IOException if the JSON string is invalid with respect to ViewFaxHistory
   */
  public static ViewFaxHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewFaxHistory.class);
  }

  /**
   * Convert an instance of ViewFaxHistory to an JSON string
   *
   * @return JSON string
   */
