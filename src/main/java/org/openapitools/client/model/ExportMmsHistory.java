...
public class ExportMmsHistory {
  ...
  public ExportMmsHistory() {
  }

  public ExportMmsHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ExportMmsHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ExportMmsHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ExportMmsHistory data(@javax.annotation.Nullable ExportSmsHistoryData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportMmsHistory exportMmsHistory = (ExportMmsHistory) o;
    return Objects.equals(this.httpCode, exportMmsHistory.httpCode) &&
        Objects.equals(this.responseCode, exportMmsHistory.responseCode) &&
        Objects.equals(this.responseMsg, exportMmsHistory.responseMsg) &&
        Objects.equals(this.data, exportMmsHistory.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportMmsHistory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportMmsHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportMmsHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExportMmsHistory is not found in the empty JSON string", ExportMmsHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportMmsHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ExportMmsHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportMmsHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportMmsHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportMmsHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportMmsHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportMmsHistory>() {
           @Override
           public void write(JsonWriter out, ExportMmsHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportMmsHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportMmsHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportMmsHistory
   * @throws IOException if the JSON string is invalid with respect to ExportMmsHistory
   */
  public static ExportMmsHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportMmsHistory.class);
  }

  /**
   * Convert an instance of ExportMmsHistory to an JSON string
   *
   * @return JSON string
   */
