...
import org.openapitools.client.model.GenerateNewApiKeyData;
...
public class GenerateNewApiKey {
  ...
  @javax.annotation.Nullable
  private GenerateNewApiKeyData data;

  public GenerateNewApiKey() {
  }

  public GenerateNewApiKey httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public GenerateNewApiKey responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public GenerateNewApiKey responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public GenerateNewApiKey data(@javax.annotation.Nullable GenerateNewApiKeyData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public GenerateNewApiKeyData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable GenerateNewApiKeyData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    GenerateNewApiKey generateNewApiKey = (GenerateNewApiKey) o;
    return Objects.equals(this.httpCode, generateNewApiKey.httpCode) &&
        Objects.equals(this.responseCode, generateNewApiKey.responseCode) &&
        Objects.equals(this.responseMsg, generateNewApiKey.responseMsg) &&
        Objects.equals(this.data, generateNewApiKey.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GenerateNewApiKey {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GenerateNewApiKey
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GenerateNewApiKey.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GenerateNewApiKey is not found in the empty JSON string", GenerateNewApiKey.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GenerateNewApiKey.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GenerateNewApiKey` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        GenerateNewApiKeyData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GenerateNewApiKey.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GenerateNewApiKey' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GenerateNewApiKey> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GenerateNewApiKey.class));

       return (TypeAdapter<T>) new TypeAdapter<GenerateNewApiKey>() {
           @Override
           public void write(JsonWriter out, GenerateNewApiKey value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GenerateNewApiKey read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GenerateNewApiKey given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GenerateNewApiKey
   * @throws IOException if the JSON string is invalid with respect to GenerateNewApiKey
   */
  public static GenerateNewApiKey fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GenerateNewApiKey.class);
  }

  /**
   * Convert an instance of GenerateNewApiKey to an JSON string
   *
   * @return JSON string
   */
