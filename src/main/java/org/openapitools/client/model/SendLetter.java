...
import org.openapitools.client.model.SendLetterData;
...
public class SendLetter {
  ...
  @javax.annotation.Nullable
  private SendLetterData data;

  public SendLetter() {
  }

  public SendLetter httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendLetter responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendLetter responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendLetter data(@javax.annotation.Nullable SendLetterData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public SendLetterData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable SendLetterData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    SendLetter sendLetter = (SendLetter) o;
    return Objects.equals(this.httpCode, sendLetter.httpCode) &&
        Objects.equals(this.responseCode, sendLetter.responseCode) &&
        Objects.equals(this.responseMsg, sendLetter.responseMsg) &&
        Objects.equals(this.data, sendLetter.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendLetter
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendLetter.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendLetter is not found in the empty JSON string", SendLetter.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendLetter.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendLetter` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        SendLetterData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendLetter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendLetter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendLetter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendLetter.class));

       return (TypeAdapter<T>) new TypeAdapter<SendLetter>() {
           @Override
           public void write(JsonWriter out, SendLetter value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendLetter read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendLetter given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendLetter
   * @throws IOException if the JSON string is invalid with respect to SendLetter
   */
  public static SendLetter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendLetter.class);
  }

  /**
   * Convert an instance of SendLetter to an JSON string
   *
   * @return JSON string
   */
