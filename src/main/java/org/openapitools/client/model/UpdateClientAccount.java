...
public class UpdateClientAccount {
  ...
  public UpdateClientAccount httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdateClientAccount responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateClientAccount responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateClientAccount data(@javax.annotation.Nullable CreateResellerAccountData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateClientAccount updateClientAccount = (UpdateClientAccount) o;
    return Objects.equals(this.httpCode, updateClientAccount.httpCode) &&
        Objects.equals(this.responseCode, updateClientAccount.responseCode) &&
        Objects.equals(this.responseMsg, updateClientAccount.responseMsg) &&
        Objects.equals(this.data, updateClientAccount.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateClientAccount {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateClientAccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateClientAccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateClientAccount is not found in the empty JSON string", UpdateClientAccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateClientAccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateClientAccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateClientAccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateClientAccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateClientAccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateClientAccount.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateClientAccount>() {
           @Override
           public void write(JsonWriter out, UpdateClientAccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateClientAccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateClientAccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateClientAccount
   * @throws IOException if the JSON string is invalid with respect to UpdateClientAccount
   */
  public static UpdateClientAccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateClientAccount.class);
  }

  /**
   * Convert an instance of UpdateClientAccount to an JSON string
   *
   * @return JSON string
   */
