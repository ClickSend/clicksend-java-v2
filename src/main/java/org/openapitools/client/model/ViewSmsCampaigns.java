...
import org.openapitools.client.model.ViewSmsCampaignsData;
...
public class ViewSmsCampaigns {
  ...
  @javax.annotation.Nullable
  private ViewSmsCampaignsData data;

  public ViewSmsCampaigns() {
  }

  public ViewSmsCampaigns httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewSmsCampaigns responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewSmsCampaigns responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewSmsCampaigns data(@javax.annotation.Nullable ViewSmsCampaignsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewSmsCampaignsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewSmsCampaignsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewSmsCampaigns viewSmsCampaigns = (ViewSmsCampaigns) o;
    return Objects.equals(this.httpCode, viewSmsCampaigns.httpCode) &&
        Objects.equals(this.responseCode, viewSmsCampaigns.responseCode) &&
        Objects.equals(this.responseMsg, viewSmsCampaigns.responseMsg) &&
        Objects.equals(this.data, viewSmsCampaigns.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSmsCampaigns {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSmsCampaigns
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSmsCampaigns.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSmsCampaigns is not found in the empty JSON string", ViewSmsCampaigns.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSmsCampaigns.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSmsCampaigns` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewSmsCampaignsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSmsCampaigns.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSmsCampaigns' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSmsCampaigns> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSmsCampaigns.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSmsCampaigns>() {
           @Override
           public void write(JsonWriter out, ViewSmsCampaigns value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSmsCampaigns read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSmsCampaigns given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSmsCampaigns
   * @throws IOException if the JSON string is invalid with respect to ViewSmsCampaigns
   */
  public static ViewSmsCampaigns fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSmsCampaigns.class);
  }

  /**
   * Convert an instance of ViewSmsCampaigns to an JSON string
   *
   * @return JSON string
   */
