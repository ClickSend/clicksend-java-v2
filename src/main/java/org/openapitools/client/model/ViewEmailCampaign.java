...
public class ViewEmailCampaign {
  ...
  public ViewEmailCampaign() {
  }

  public ViewEmailCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewEmailCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewEmailCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewEmailCampaign data(@javax.annotation.Nullable EmailCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewEmailCampaign viewEmailCampaign = (ViewEmailCampaign) o;
    return Objects.equals(this.httpCode, viewEmailCampaign.httpCode) &&
        Objects.equals(this.responseCode, viewEmailCampaign.responseCode) &&
        Objects.equals(this.responseMsg, viewEmailCampaign.responseMsg) &&
        Objects.equals(this.data, viewEmailCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewEmailCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewEmailCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewEmailCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewEmailCampaign is not found in the empty JSON string", ViewEmailCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewEmailCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewEmailCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewEmailCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewEmailCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewEmailCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewEmailCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewEmailCampaign>() {
           @Override
           public void write(JsonWriter out, ViewEmailCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewEmailCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewEmailCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewEmailCampaign
   * @throws IOException if the JSON string is invalid with respect to ViewEmailCampaign
   */
  public static ViewEmailCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewEmailCampaign.class);
  }

  /**
   * Convert an instance of ViewEmailCampaign to an JSON string
   *
   * @return JSON string
   */
