...
public class ExportVoiceHistory {
  ...
  public ExportVoiceHistory() {
  }

  public ExportVoiceHistory httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ExportVoiceHistory responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ExportVoiceHistory responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ExportVoiceHistory data(@javax.annotation.Nullable ExportSmsHistoryData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ExportVoiceHistory exportVoiceHistory = (ExportVoiceHistory) o;
    return Objects.equals(this.httpCode, exportVoiceHistory.httpCode) &&
        Objects.equals(this.responseCode, exportVoiceHistory.responseCode) &&
        Objects.equals(this.responseMsg, exportVoiceHistory.responseMsg) &&
        Objects.equals(this.data, exportVoiceHistory.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExportVoiceHistory {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ExportVoiceHistory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ExportVoiceHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ExportVoiceHistory is not found in the empty JSON string", ExportVoiceHistory.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ExportVoiceHistory.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ExportVoiceHistory` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExportVoiceHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExportVoiceHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExportVoiceHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExportVoiceHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<ExportVoiceHistory>() {
           @Override
           public void write(JsonWriter out, ExportVoiceHistory value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ExportVoiceHistory read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ExportVoiceHistory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ExportVoiceHistory
   * @throws IOException if the JSON string is invalid with respect to ExportVoiceHistory
   */
  public static ExportVoiceHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExportVoiceHistory.class);
  }

  /**
   * Convert an instance of ExportVoiceHistory to an JSON string
   *
   * @return JSON string
   */
