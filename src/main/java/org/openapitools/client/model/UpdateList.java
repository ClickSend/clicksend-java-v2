...
public class UpdateList {
  ...
  public UpdateList httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdateList responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateList responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateList data(@javax.annotation.Nullable ContactList data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, updateList.httpCode) &&
        Objects.equals(this.responseCode, updateList.responseCode) &&
        Objects.equals(this.responseMsg, updateList.responseMsg) &&
        Objects.equals(this.data, updateList.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateList.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateList is not found in the empty JSON string", UpdateList.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateList.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateList` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
