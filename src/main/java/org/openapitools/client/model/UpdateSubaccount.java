...
public class UpdateSubaccount {
  ...
  public UpdateSubaccount httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdateSubaccount responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateSubaccount responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateSubaccount data(@javax.annotation.Nullable Subaccount data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    UpdateSubaccount updateSubaccount = (UpdateSubaccount) o;
    return Objects.equals(this.httpCode, updateSubaccount.httpCode) &&
        Objects.equals(this.responseCode, updateSubaccount.responseCode) &&
        Objects.equals(this.responseMsg, updateSubaccount.responseMsg) &&
        Objects.equals(this.data, updateSubaccount.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateSubaccount {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to UpdateSubaccount
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateSubaccount.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateSubaccount is not found in the empty JSON string", UpdateSubaccount.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateSubaccount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateSubaccount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UpdateSubaccount.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UpdateSubaccount' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UpdateSubaccount> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UpdateSubaccount.class));

       return (TypeAdapter<T>) new TypeAdapter<UpdateSubaccount>() {
           @Override
           public void write(JsonWriter out, UpdateSubaccount value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UpdateSubaccount read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of UpdateSubaccount given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of UpdateSubaccount
   * @throws IOException if the JSON string is invalid with respect to UpdateSubaccount
   */
  public static UpdateSubaccount fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UpdateSubaccount.class);
  }

  /**
   * Convert an instance of UpdateSubaccount to an JSON string
   *
   * @return JSON string
   */
