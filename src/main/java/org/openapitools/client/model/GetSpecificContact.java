...
public class GetSpecificContact {
  ...
  public GetSpecificContact() {
  }

  public GetSpecificContact httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public GetSpecificContact responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public GetSpecificContact responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public GetSpecificContact data(@javax.annotation.Nullable Contact data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetSpecificContact getSpecificContact = (GetSpecificContact) o;
    return Objects.equals(this.httpCode, getSpecificContact.httpCode) &&
        Objects.equals(this.responseCode, getSpecificContact.responseCode) &&
        Objects.equals(this.responseMsg, getSpecificContact.responseMsg) &&
        Objects.equals(this.data, getSpecificContact.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetSpecificContact {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetSpecificContact
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetSpecificContact.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in GetSpecificContact is not found in the empty JSON string", GetSpecificContact.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetSpecificContact.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetSpecificContact` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetSpecificContact.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetSpecificContact' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetSpecificContact> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetSpecificContact.class));

       return (TypeAdapter<T>) new TypeAdapter<GetSpecificContact>() {
           @Override
           public void write(JsonWriter out, GetSpecificContact value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetSpecificContact read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetSpecificContact given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetSpecificContact
   * @throws IOException if the JSON string is invalid with respect to GetSpecificContact
   */
  public static GetSpecificContact fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetSpecificContact.class);
  }

  /**
   * Convert an instance of GetSpecificContact to an JSON string
   *
   * @return JSON string
   */
