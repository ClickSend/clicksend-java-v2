...
public class AddAllowedEmail {
  ...
  public AddAllowedEmail httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public AddAllowedEmail responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public AddAllowedEmail responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public boolean equals(Object o) {
    ...
    AddAllowedEmail addAllowedEmail = (AddAllowedEmail) o;
    return Objects.equals(this.httpCode, addAllowedEmail.httpCode) &&
        Objects.equals(this.responseCode, addAllowedEmail.responseCode) &&
        Objects.equals(this.responseMsg, addAllowedEmail.responseMsg) &&
        Objects.equals(this.data, addAllowedEmail.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddAllowedEmail {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to AddAllowedEmail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!AddAllowedEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in AddAllowedEmail is not found in the empty JSON string", AddAllowedEmail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AddAllowedEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `AddAllowedEmail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddAllowedEmail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddAllowedEmail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddAllowedEmail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddAllowedEmail.class));

       return (TypeAdapter<T>) new TypeAdapter<AddAllowedEmail>() {
           @Override
           public void write(JsonWriter out, AddAllowedEmail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AddAllowedEmail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of AddAllowedEmail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of AddAllowedEmail
   * @throws IOException if the JSON string is invalid with respect to AddAllowedEmail
   */
  public static AddAllowedEmail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddAllowedEmail.class);
  }

  /**
   * Convert an instance of AddAllowedEmail to an JSON string
   *
   * @return JSON string
   */
