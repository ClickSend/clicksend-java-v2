...
public class CreateEmailTemplate {
  ...
  public CreateEmailTemplate httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CreateEmailTemplate responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CreateEmailTemplate responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CreateEmailTemplate data(@javax.annotation.Nullable UserEmailTemplate data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, createEmailTemplate.httpCode) &&
        Objects.equals(this.responseCode, createEmailTemplate.responseCode) &&
        Objects.equals(this.responseMsg, createEmailTemplate.responseMsg) &&
        Objects.equals(this.data, createEmailTemplate.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateEmailTemplate
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateEmailTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateEmailTemplate is not found in the empty JSON string", CreateEmailTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateEmailTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateEmailTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
