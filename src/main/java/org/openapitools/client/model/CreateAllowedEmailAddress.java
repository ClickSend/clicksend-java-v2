...
public class CreateAllowedEmailAddress {
  ...
  public CreateAllowedEmailAddress() {
  }

  public CreateAllowedEmailAddress httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CreateAllowedEmailAddress responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CreateAllowedEmailAddress responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CreateAllowedEmailAddress data(@javax.annotation.Nullable EmailAddress data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CreateAllowedEmailAddress createAllowedEmailAddress = (CreateAllowedEmailAddress) o;
    return Objects.equals(this.httpCode, createAllowedEmailAddress.httpCode) &&
        Objects.equals(this.responseCode, createAllowedEmailAddress.responseCode) &&
        Objects.equals(this.responseMsg, createAllowedEmailAddress.responseMsg) &&
        Objects.equals(this.data, createAllowedEmailAddress.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateAllowedEmailAddress {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CreateAllowedEmailAddress
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CreateAllowedEmailAddress.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CreateAllowedEmailAddress is not found in the empty JSON string", CreateAllowedEmailAddress.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CreateAllowedEmailAddress.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CreateAllowedEmailAddress` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CreateAllowedEmailAddress.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CreateAllowedEmailAddress' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CreateAllowedEmailAddress> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CreateAllowedEmailAddress.class));

       return (TypeAdapter<T>) new TypeAdapter<CreateAllowedEmailAddress>() {
           @Override
           public void write(JsonWriter out, CreateAllowedEmailAddress value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CreateAllowedEmailAddress read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CreateAllowedEmailAddress given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CreateAllowedEmailAddress
   * @throws IOException if the JSON string is invalid with respect to CreateAllowedEmailAddress
   */
  public static CreateAllowedEmailAddress fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CreateAllowedEmailAddress.class);
  }

  /**
   * Convert an instance of CreateAllowedEmailAddress to an JSON string
   *
   * @return JSON string
   */
