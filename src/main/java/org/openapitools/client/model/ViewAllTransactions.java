...
import org.openapitools.client.model.ViewAllTransactionsData;
...
public class ViewAllTransactions {
  ...
  @javax.annotation.Nullable
  private ViewAllTransactionsData data;

  public ViewAllTransactions() {
  }

  public ViewAllTransactions httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewAllTransactions responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewAllTransactions responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewAllTransactions data(@javax.annotation.Nullable ViewAllTransactionsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewAllTransactionsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewAllTransactionsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewAllTransactions viewAllTransactions = (ViewAllTransactions) o;
    return Objects.equals(this.httpCode, viewAllTransactions.httpCode) &&
        Objects.equals(this.responseCode, viewAllTransactions.responseCode) &&
        Objects.equals(this.responseMsg, viewAllTransactions.responseMsg) &&
        Objects.equals(this.data, viewAllTransactions.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAllTransactions
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAllTransactions.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAllTransactions is not found in the empty JSON string", ViewAllTransactions.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAllTransactions.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAllTransactions` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewAllTransactionsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAllTransactions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAllTransactions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAllTransactions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAllTransactions.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAllTransactions>() {
           @Override
           public void write(JsonWriter out, ViewAllTransactions value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAllTransactions read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAllTransactions given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAllTransactions
   * @throws IOException if the JSON string is invalid with respect to ViewAllTransactions
   */
  public static ViewAllTransactions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAllTransactions.class);
  }

  /**
   * Convert an instance of ViewAllTransactions to an JSON string
   *
   * @return JSON string
   */
