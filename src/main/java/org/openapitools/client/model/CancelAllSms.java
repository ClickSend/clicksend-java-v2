...
public class CancelAllSms {
  ...
  public CancelAllSms httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CancelAllSms responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CancelAllSms responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CancelAllSms data(@javax.annotation.Nullable CancelAllSmsData data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelAllSms cancelAllSms = (CancelAllSms) o;
    return Objects.equals(this.httpCode, cancelAllSms.httpCode) &&
        Objects.equals(this.responseCode, cancelAllSms.responseCode) &&
        Objects.equals(this.responseMsg, cancelAllSms.responseMsg) &&
        Objects.equals(this.data, cancelAllSms.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelAllSms
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelAllSms.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelAllSms is not found in the empty JSON string", CancelAllSms.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelAllSms.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelAllSms` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelAllSms.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelAllSms' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelAllSms> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelAllSms.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelAllSms>() {
           @Override
           public void write(JsonWriter out, CancelAllSms value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelAllSms read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelAllSms given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelAllSms
   * @throws IOException if the JSON string is invalid with respect to CancelAllSms
   */
  public static CancelAllSms fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelAllSms.class);
  }

  /**
   * Convert an instance of CancelAllSms to an JSON string
   *
   * @return JSON string
   */
