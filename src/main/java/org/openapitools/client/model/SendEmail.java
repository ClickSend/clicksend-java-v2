...
public class SendEmail {
  ...
  @javax.annotation.Nullable
  private TransactionalEmail data;

  public SendEmail() {
  }

  public SendEmail httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public SendEmail responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendEmail responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendEmail data(@javax.annotation.Nullable TransactionalEmail data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public TransactionalEmail getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable TransactionalEmail data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, sendEmail.httpCode) &&
        Objects.equals(this.responseCode, sendEmail.responseCode) &&
        Objects.equals(this.responseMsg, sendEmail.responseMsg) &&
        Objects.equals(this.data, sendEmail.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendEmail
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendEmail.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendEmail is not found in the empty JSON string", SendEmail.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendEmail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendEmail` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        TransactionalEmail.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendEmail.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendEmail' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendEmail> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendEmail.class));

       return (TypeAdapter<T>) new TypeAdapter<SendEmail>() {
           @Override
           public void write(JsonWriter out, SendEmail value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public SendEmail read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of SendEmail given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SendEmail
   * @throws IOException if the JSON string is invalid with respect to SendEmail
   */
  public static SendEmail fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendEmail.class);
  }

  /**
   * Convert an instance of SendEmail to an JSON string
   *
   * @return JSON string
   */
