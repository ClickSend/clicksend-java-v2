...
import org.openapitools.client.model.ViewFaxReceiptsData;
...
public class ViewFaxReceipts {
  ...
  @javax.annotation.Nullable
  private ViewFaxReceiptsData data;

  public ViewFaxReceipts() {
  }

  public ViewFaxReceipts httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewFaxReceipts responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewFaxReceipts responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewFaxReceipts data(@javax.annotation.Nullable ViewFaxReceiptsData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewFaxReceiptsData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewFaxReceiptsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewFaxReceipts viewFaxReceipts = (ViewFaxReceipts) o;
    return Objects.equals(this.httpCode, viewFaxReceipts.httpCode) &&
        Objects.equals(this.responseCode, viewFaxReceipts.responseCode) &&
        Objects.equals(this.responseMsg, viewFaxReceipts.responseMsg) &&
        Objects.equals(this.data, viewFaxReceipts.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewFaxReceipts {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewFaxReceipts
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewFaxReceipts.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewFaxReceipts is not found in the empty JSON string", ViewFaxReceipts.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewFaxReceipts.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewFaxReceipts` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewFaxReceiptsData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewFaxReceipts.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewFaxReceipts' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewFaxReceipts> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewFaxReceipts.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewFaxReceipts>() {
           @Override
           public void write(JsonWriter out, ViewFaxReceipts value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewFaxReceipts read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewFaxReceipts given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewFaxReceipts
   * @throws IOException if the JSON string is invalid with respect to ViewFaxReceipts
   */
  public static ViewFaxReceipts fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewFaxReceipts.class);
  }

  /**
   * Convert an instance of ViewFaxReceipts to an JSON string
   *
   * @return JSON string
   */
