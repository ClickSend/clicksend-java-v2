...
public class CancelMmsCampaign {
  ...
  @javax.annotation.Nullable
  private MmsCampaign data;

  public CancelMmsCampaign() {
  }

  public CancelMmsCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public CancelMmsCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public CancelMmsCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public CancelMmsCampaign data(@javax.annotation.Nullable MmsCampaign data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public MmsCampaign getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable MmsCampaign data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    CancelMmsCampaign cancelMmsCampaign = (CancelMmsCampaign) o;
    return Objects.equals(this.httpCode, cancelMmsCampaign.httpCode) &&
        Objects.equals(this.responseCode, cancelMmsCampaign.responseCode) &&
        Objects.equals(this.responseMsg, cancelMmsCampaign.responseMsg) &&
        Objects.equals(this.data, cancelMmsCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class CancelMmsCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to CancelMmsCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!CancelMmsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in CancelMmsCampaign is not found in the empty JSON string", CancelMmsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CancelMmsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `CancelMmsCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        MmsCampaign.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CancelMmsCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CancelMmsCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CancelMmsCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CancelMmsCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<CancelMmsCampaign>() {
           @Override
           public void write(JsonWriter out, CancelMmsCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CancelMmsCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of CancelMmsCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of CancelMmsCampaign
   * @throws IOException if the JSON string is invalid with respect to CancelMmsCampaign
   */
  public static CancelMmsCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CancelMmsCampaign.class);
  }

  /**
   * Convert an instance of CancelMmsCampaign to an JSON string
   *
   * @return JSON string
   */
