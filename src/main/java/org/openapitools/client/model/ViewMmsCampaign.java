...
public class ViewMmsCampaign {
  ...
  public ViewMmsCampaign() {
  }

  public ViewMmsCampaign httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewMmsCampaign responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewMmsCampaign responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewMmsCampaign data(@javax.annotation.Nullable MmsCampaign data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewMmsCampaign viewMmsCampaign = (ViewMmsCampaign) o;
    return Objects.equals(this.httpCode, viewMmsCampaign.httpCode) &&
        Objects.equals(this.responseCode, viewMmsCampaign.responseCode) &&
        Objects.equals(this.responseMsg, viewMmsCampaign.responseMsg) &&
        Objects.equals(this.data, viewMmsCampaign.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewMmsCampaign {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewMmsCampaign
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewMmsCampaign.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewMmsCampaign is not found in the empty JSON string", ViewMmsCampaign.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewMmsCampaign.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewMmsCampaign` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewMmsCampaign.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewMmsCampaign' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewMmsCampaign> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewMmsCampaign.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewMmsCampaign>() {
           @Override
           public void write(JsonWriter out, ViewMmsCampaign value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewMmsCampaign read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewMmsCampaign given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewMmsCampaign
   * @throws IOException if the JSON string is invalid with respect to ViewMmsCampaign
   */
  public static ViewMmsCampaign fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewMmsCampaign.class);
  }

  /**
   * Convert an instance of ViewMmsCampaign to an JSON string
   *
   * @return JSON string
   */
