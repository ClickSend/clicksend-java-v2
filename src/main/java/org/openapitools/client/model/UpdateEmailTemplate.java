...
public class UpdateEmailTemplate {
  ...
  public UpdateEmailTemplate httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public UpdateEmailTemplate responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public UpdateEmailTemplate responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public UpdateEmailTemplate data(@javax.annotation.Nullable UserEmailTemplate data) {
    this.data = data;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, updateEmailTemplate.httpCode) &&
        Objects.equals(this.responseCode, updateEmailTemplate.responseCode) &&
        Objects.equals(this.responseMsg, updateEmailTemplate.responseMsg) &&
        Objects.equals(this.data, updateEmailTemplate.data);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateEmailTemplate.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in UpdateEmailTemplate is not found in the empty JSON string", UpdateEmailTemplate.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateEmailTemplate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `UpdateEmailTemplate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
