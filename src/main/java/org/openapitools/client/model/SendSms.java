...
import org.openapitools.client.model.SendSmsData;
...
public class SendSms {
  ...
  public SendSms httpCode(@javax.annotation.Nullable String httpCode) {
  ...
  public SendSms responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public SendSms responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public SendSms data(@javax.annotation.Nullable SendSmsData data) {
    this.data = data;
    return this;
  }
  ...
  public void setData(@javax.annotation.Nullable SendSmsData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.httpCode, sendSms.httpCode) &&
        Objects.equals(this.responseCode, sendSms.responseCode) &&
        Objects.equals(this.responseMsg, sendSms.responseMsg) &&
        Objects.equals(this.data, sendSms.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SendSms
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SendSms.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in SendSms is not found in the empty JSON string", SendSms.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!SendSms.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `SendSms` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        SendSmsData.validateJsonElement(jsonObj.get("data"));
      }
  }
