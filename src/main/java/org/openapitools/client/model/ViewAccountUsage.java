...
import org.openapitools.client.model.ViewAccountUsageData;
...
public class ViewAccountUsage {
  ...
  @javax.annotation.Nullable
  private ViewAccountUsageData data;

  public ViewAccountUsage() {
  }

  public ViewAccountUsage httpCode(@javax.annotation.Nullable Integer httpCode) {
  ...
  public ViewAccountUsage responseCode(@javax.annotation.Nullable String responseCode) {
  ...
  public ViewAccountUsage responseMsg(@javax.annotation.Nullable String responseMsg) {
  ...
  public ViewAccountUsage data(@javax.annotation.Nullable ViewAccountUsageData data) {
    this.data = data;
    return this;
  }
   ...
   */
  @javax.annotation.Nullable
  public ViewAccountUsageData getData() {
    return data;
  }

  public void setData(@javax.annotation.Nullable ViewAccountUsageData data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ViewAccountUsage viewAccountUsage = (ViewAccountUsage) o;
    return Objects.equals(this.httpCode, viewAccountUsage.httpCode) &&
        Objects.equals(this.responseCode, viewAccountUsage.responseCode) &&
        Objects.equals(this.responseMsg, viewAccountUsage.responseMsg) &&
        Objects.equals(this.data, viewAccountUsage.data);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewAccountUsage
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewAccountUsage.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewAccountUsage is not found in the empty JSON string", ViewAccountUsage.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewAccountUsage.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewAccountUsage` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("data") != null && !jsonObj.get("data").isJsonNull()) {
        ViewAccountUsageData.validateJsonElement(jsonObj.get("data"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewAccountUsage.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewAccountUsage' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewAccountUsage> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewAccountUsage.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewAccountUsage>() {
           @Override
           public void write(JsonWriter out, ViewAccountUsage value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewAccountUsage read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewAccountUsage given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewAccountUsage
   * @throws IOException if the JSON string is invalid with respect to ViewAccountUsage
   */
  public static ViewAccountUsage fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewAccountUsage.class);
  }

  /**
   * Convert an instance of ViewAccountUsage to an JSON string
   *
   * @return JSON string
   */
