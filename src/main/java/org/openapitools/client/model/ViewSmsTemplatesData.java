...
public class ViewSmsTemplatesData {
  ...
  public ViewSmsTemplatesData() {
  }

  public ViewSmsTemplatesData total(@javax.annotation.Nullable Integer total) {
    this.total = total;
    return this;
  }
  ...
  public ViewSmsTemplatesData perPage(@javax.annotation.Nullable Integer perPage) {
  ...
  public ViewSmsTemplatesData currentPage(@javax.annotation.Nullable Integer currentPage) {
  ...
  public ViewSmsTemplatesData lastPage(@javax.annotation.Nullable Integer lastPage) {
  ...
  public ViewSmsTemplatesData nextPageUrl(@javax.annotation.Nullable String nextPageUrl) {
  ...
  public ViewSmsTemplatesData prevPageUrl(@javax.annotation.Nullable String prevPageUrl) {
  ...
  public ViewSmsTemplatesData from(@javax.annotation.Nullable Integer from) {
    this.from = from;
    return this;
  }
  ...
  public ViewSmsTemplatesData to(@javax.annotation.Nullable Integer to) {
    this.to = to;
    return this;
  }
  ...
  public ViewSmsTemplatesData data(@javax.annotation.Nullable List<SmsTemplate> data) {
    this.data = data;
    return this;
  }

  public ViewSmsTemplatesData addDataItem(SmsTemplate dataItem) {
    if (this.data == null) {
  ...
  public boolean equals(Object o) {
    ...
    ViewSmsTemplatesData viewSmsTemplatesData = (ViewSmsTemplatesData) o;
    return Objects.equals(this.total, viewSmsTemplatesData.total) &&
        Objects.equals(this.perPage, viewSmsTemplatesData.perPage) &&
        Objects.equals(this.currentPage, viewSmsTemplatesData.currentPage) &&
        Objects.equals(this.lastPage, viewSmsTemplatesData.lastPage) &&
        Objects.equals(this.nextPageUrl, viewSmsTemplatesData.nextPageUrl) &&
        Objects.equals(this.prevPageUrl, viewSmsTemplatesData.prevPageUrl) &&
        Objects.equals(this.from, viewSmsTemplatesData.from) &&
        Objects.equals(this.to, viewSmsTemplatesData.to) &&
        Objects.equals(this.data, viewSmsTemplatesData.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ViewSmsTemplatesData {\n");
   ...
   * @throws IOException if the JSON Element is invalid with respect to ViewSmsTemplatesData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ViewSmsTemplatesData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The required field(s) %s in ViewSmsTemplatesData is not found in the empty JSON string", ViewSmsTemplatesData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ViewSmsTemplatesData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(java.util.Locale.ROOT, "The field `%s` in the JSON string is not defined in the `ViewSmsTemplatesData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ViewSmsTemplatesData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ViewSmsTemplatesData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ViewSmsTemplatesData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ViewSmsTemplatesData.class));

       return (TypeAdapter<T>) new TypeAdapter<ViewSmsTemplatesData>() {
           @Override
           public void write(JsonWriter out, ViewSmsTemplatesData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ViewSmsTemplatesData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of ViewSmsTemplatesData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of ViewSmsTemplatesData
   * @throws IOException if the JSON string is invalid with respect to ViewSmsTemplatesData
   */
  public static ViewSmsTemplatesData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ViewSmsTemplatesData.class);
  }

  /**
   * Convert an instance of ViewSmsTemplatesData to an JSON string
   *
   * @return JSON string
   */
