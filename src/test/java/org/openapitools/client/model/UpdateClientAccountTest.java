...
/**
 * Model tests for UpdateClientAccount
 */
public class UpdateClientAccountTest {
    private final UpdateClientAccount model = new UpdateClientAccount();
