...
/**
 * Model tests for GenerateNewApiKey
 */
public class GenerateNewApiKeyTest {
    private final GenerateNewApiKey model = new GenerateNewApiKey();
