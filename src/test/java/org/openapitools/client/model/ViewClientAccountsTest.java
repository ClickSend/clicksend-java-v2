...
/**
 * Model tests for ViewClientAccounts
 */
public class ViewClientAccountsTest {
    private final ViewClientAccounts model = new ViewClientAccounts();
