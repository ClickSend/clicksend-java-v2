...
/**
 * Model tests for DeleteSmsTemplate
 */
public class DeleteSmsTemplateTest {
    private final DeleteSmsTemplate model = new DeleteSmsTemplate();
