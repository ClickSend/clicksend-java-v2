...
/**
 * Model tests for UpdateSmsTemplate
 */
public class UpdateSmsTemplateTest {
    private final UpdateSmsTemplate model = new UpdateSmsTemplate();
