...
/**
 * Model tests for ViewEmailTemplate
 */
public class ViewEmailTemplateTest {
    private final ViewEmailTemplate model = new ViewEmailTemplate();
