...
/**
 * Model tests for ViewAllTransactions
 */
public class ViewAllTransactionsTest {
    private final ViewAllTransactions model = new ViewAllTransactions();
