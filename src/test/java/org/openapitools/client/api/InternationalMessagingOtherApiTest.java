...
/**
 * API tests for InternationalMessagingOtherApi
 */
@Disabled
public class InternationalMessagingOtherApiTest {

    private final InternationalMessagingOtherApi api = new InternationalMessagingOtherApi();
