...
/**
 * Model tests for CreateSmsTemplate
 */
public class CreateSmsTemplateTest {
    private final CreateSmsTemplate model = new CreateSmsTemplate();
