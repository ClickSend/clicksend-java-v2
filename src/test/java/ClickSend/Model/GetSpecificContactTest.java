...
/**
 * Model tests for GetSpecificContact
 */
public class GetSpecificContactTest {
    private final GetSpecificContact model = new GetSpecificContact();
