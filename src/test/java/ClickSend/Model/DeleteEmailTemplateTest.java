...
/**
 * Model tests for DeleteEmailTemplate
 */
public class DeleteEmailTemplateTest {
    private final DeleteEmailTemplate model = new DeleteEmailTemplate();
